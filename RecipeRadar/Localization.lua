...
-- the name of the addon!
   RecipeRadar_Strings["Recipe Radar"] = "专业配方图纸售卖地及掉落地查询"
   ...
   RecipeRadar_Strings["Alchemy"] = "炼金术"
   ...
   RecipeRadar_Strings["Netherwing"] = "灵翼之龙"
   RecipeRadar_Strings["Sporeggar"] = "孢子村"
   ...
   RecipeRadar_Strings["Brood of Nozdormu"] = "诺兹多姆的子嗣"
   RecipeRadar_Strings["Ashtongue Deathsworn"] = "灰舌死誓者"
   RecipeRadar_Strings["Bloodsail Buccaneers"] = "血帆海盗"
   RecipeRadar_Strings["Darkmoon Faire"] = "暗月马戏团"
   RecipeRadar_Strings["Shattered Sun Offensive"] = "破碎残阳"  
   ...
   RecipeRadar_Strings["Instances"] = "副本"
   RecipeRadar_Strings["Outland"] = "外域"
   ...
   RecipeRadar_Strings["Isle of Quel'Danas"] = "奎尔丹纳斯岛"
   ...
   RecipeRadar_Strings["Eldara Dawnrunner"]="艾尔达拉·晨行者<47,30>"
   RecipeRadar_Strings["Shaani"]="珊妮<46,30>"

AtlasLoot_Data["AtlasLootWBItems"] = {
    ...
    AAzuregos = {
        ...
        { 17070, "INV_Weapon_ShortBlade_06", "=q4=Fang of the Mystics", "=ds=#h3#, #w4#", "13.64%" },
        ...
        { 0,"","","" },
        { 0,"","","" },
        { 18704, "INV_Misc_Bandage_04", "=q4=Mature Blue Dragon Sinew", "=ds=#m3# =q1=(#c2#)", "51.56%" },
        { 18714, "INV_Misc_Quiver_03", "=q4=Ancient Sinew Wrapped Lamina", "=q1=#m4#: =ds=#m14# #w19#" },
        };

    DoomLordKazzak = {
        { 30735, "INV_Misc_Cape_05", "=q4=Ancient Spellcloak of the Highborne", "=ds=#s4#", "16.5%" },
        { 30734, "INV_Pants_Leather_11", "=q4=Leggings of the Seventh Circle", "=ds=#s11#, #a1#", "17.0%" },
        { 30737, "INV_Boots_Cloth_08", "=q4=Gold-Leaf Wildboots", "=ds=#s12#, #a2#", "21.1%" },
        { 30739, "INV_Pants_Mail_11", "=q4=Scaled Greaves of the Marksman", "=ds=#s11#, #a3#", "14.0%" },
        { 30740, "INV_Shoulder_36", "=q4=Ripfiend Shoulderplates", "=ds=#s3#, #a4#", "16.1%" },
        { 30741, "INV_Gauntlets_28", "=q4=Topaz-Studded Battlegrips", "=ds=#s9#, #a4#", "17.0%" },
        { 30736, "INV_Jewelry_Ring_60", "=q4=Ring of Flowing Light", "=ds=#s13#", "15.8%" },
        { 30738, "INV_Jewelry_Ring_04", "=q4=Ring of Reciprocity", "=ds=#s13#", "23.4%" },
        { 30733, "INV_Sword_74", "=q4=Hope Ender", "=ds=#h1#, #w10#", "16.7%" },
        { 30732, "INV_Staff_Draenei_A_03", "=q4=Exodar Life-Staff", "=ds=#w9#", "17.1%" },
        };

    DDoomwalker = {
        { 30729, "INV_Misc_Cape_20", "=q4=Black-Iron Battlecloak", "=ds=#s4#", "19.6%" },
        { 30725, "INV_Gauntlets_30", "=q4=Anger-Spark Gloves", "=ds=#s9#, #a1#", "17.9%" },
        { 30727, "INV_Pants_Cloth_15", "=q4=Gilded Trousers of Benediction", "=ds=#s11#, #a1#", "18.1%" },
        { 30730, "INV_Chest_Cloth_45", "=q4=Terrorweave Tunic", "=ds=#s5#, #a2#", "18.8%" },
        { 30728, "INV_Helmet_69", "=q4=Fathom-Helm of the Deeps", "=ds=#s1#, #a3#", "16.2%" },
        { 30731, "INV_Helmet_58", "=q4=Faceguard of the Endless Watch", "=ds=#s1#, #a4#", "18.1%" },
        { 30726, "INV_Jewelry_Necklace_29Naxxramas", "=q4=Archaic Charm of Presence", "=ds=#s2#", "20.9%" },
        { 30723, "INV_Weapon_Shortblade_53", "=q4=Talon of the Tempest", "=ds=#h3#, #w4#", "15.4%" },
        { 30722, "INV_Axe_67", "=q4=Ethereum Nexus-Reaver", "=ds=#h2#, #w1#", "16.0%" },
        { 30724, "INV_Weapon_Rifle_22", "=q4=Barrel-Blade Longrifle", "=ds=#w5#", "20.0%" },
        };
    ...
    DLethon = {
        ...
        { 20581, "INV_Staff_36", "=q4=Staff of Rampant Growth",		"=ds=#w9# =q1=#m5#", "9.70%" },
        { 0,"","","" },
    ...
    KKruul = {
        ...
        { 0,"","","" },
        { 0,"","","" },
        { 18665, "Spell_Shadow_UnholyFrenzy", "=q4=The Eye of Shadow", "=ds=#m2# =q1=(#c5#)", "29.98%" },

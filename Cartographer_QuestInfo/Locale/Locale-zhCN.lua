...
-- Core.lua
	...
	["Exporting %d quests..."] = "已汇出 %d 个任务...",
	["Total %d quests have been exported."] = "总计汇出 %d 个任务起始点。",
	["Clear old exported quests first."] = "首先清除旧的任务起始点。",
	["Begin exporting new quests."] = "开始汇出新的任务起始点。",

...
elseif GetLocale() == "zhCN" then
	DELETE_PROFILE = "删除"
	DELETE_PROFILE_DESC = "删除配置文件。注意：有可能别的角色也使用这个配置文件。"
	DELETE_PROFILE_USAGE = "<配置文件名称>"

	ACTIVE = "激活"
	ENABLED = "启用"
	STATE = "状态"
	TOGGLE_ACTIVE = "暂停/恢复 此插件"
	MAP_ACTIVESUSPENDED = { [true] = "|cff00ff00激活|r", [false] = "|cffff0000暂停|r" }
	SET_PROFILE = "设置此插件配置文件"
	SET_PROFILE_USAGE = "{角色 || 职业 || 服务器 || <配置文件名>}"
	PROFILE = "配置文件"
	PLAYER_OF_REALM = "%s (%s)"
	CHOOSE_PROFILE_DESC = "选择配置文件"
	CHOOSE_PROFILE_GUI = "选择"
	COPY_PROFILE_DESC = "从另一个配置文件复制设置"
	COPY_PROFILE_GUI = "复制"
	OTHER_PROFILE_DESC = "选择另一个配置文件"
	OTHER_PROFILE_GUI = "其他"
	OTHER_PROFILE_USAGE = "<配置文件名称>"
	RESET_PROFILE = "重置配置文件"
	RESET_PROFILE_DESC = "清除当前配置文件的所有设置"

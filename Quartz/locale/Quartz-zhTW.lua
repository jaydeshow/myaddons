...
L:RegisterTranslations("zhTW", function()
	return {
		...
		["Set the Cast Bar Texture"] = "設定施法條紋理",
		...
		["Set an exact Y value for this bar's position."] = "設定施法條的Y軸值",
			...
			["Embed mode will decrease it's lag estimates by this amount.  Ideally, set it to the difference between your highest and lowest ping amounts.  (ie, if your ping varies from 200ms to 400ms, set it to 0.2)"] = "嵌入模組會根據這個數值減少延遲估計值。理想上，設定為 ping 的最高/最低值的差異值是最好的 (例如，你的延遲值介於200ms到400ms，則可設為0.2)",
			["Latency Bar"] = "網路延遲條",
			...
			--Buffs
			["Show buffs/debuffs for your %s"] = "顯示你的%s的增益/減益效果",
			["Show buffs for your %s"] = "顯示你的%s的增益效果",
			["Show debuffs for your %s"] = "顯示你的的%s的減益效果",
			["Position the bars for your %s"] = "你的的%s的計時條位置",
			["Tweak the vertical position of the bars for your %s"] = "緊縮你的%s計時條的垂直位置",
			["Tweak the space between bars for your %s"] = "緊縮你的%s計時條的間隔",
			["Tweak the horizontal position of the bars for your %s"] = "緊縮你的%s計時條的水平位置",
			["Show icons on buffs and debuffs for your %s"] = "顯示你的%s的增益/減益效果的圖示",
			["Set the side of the buff bar that the icon appears on"] = "設定小圖示出現於計時條的位置",
			["Set the buff bar Texture"] = "設定增益計時條的紋理",
			...
			["Select where to anchor the %s bars"] = "選擇%s計時條的錨點",
			["Toggle %s bar lock"] = "切換鎖定%s計時條",
			["Set the grow direction of the %s bars"] = "設定%s計時條的伸展方向",
			...
			["Set the mirror bar Texture"] = "設定映射施法條的紋理",

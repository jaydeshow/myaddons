...
-----------------------------------------------------------------------------
-- MI2_EventSelfBuff_CN()
--
-- Chinese version parsing function for MI2_EventSelfBuff()
-- This function was kindly submitted by Andyca Chiou.
--
local function MI2_EventSelfBuff_CN()
...
function MI2_OnLoad()
	...
	if ( MI2_Locale == "zhCN" or MI2_Locale == "zhTW" ) then
		MI2_EventHandlers.CHAT_MSG_SPELL_PERIODIC_CREATURE_DAMAGE.f = MI2_EventSpellPeriodic_CN
		MI2_EventHandlers.CHAT_MSG_SPELL_SELF_BUFF.f = MI2_EventSelfBuff_CN

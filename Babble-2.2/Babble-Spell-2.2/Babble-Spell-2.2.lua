...
local MINOR_VERSION = tonumber(string.sub("$Revision: 80542 $", 12, -3))
...
BabbleSpell:RegisterTranslations("ruRU", function()
	return {
		...
		["Improved Bloodrage"] = "Улучшенная ярость крови",
		...
		["Improved Charge"] = "Улучшенная атака",
		["Improved Cleave"] = "Улучшенный колун",
		...
		["Improved Demoralizing Shout"] = "Улучшенный устрашающий возглас",

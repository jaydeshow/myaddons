...
local MINOR_VERSION = tonumber(string.sub("$Revision: 79116 $", 12, -3))
...
BabbleSpell:RegisterTranslations("ruRU", function()
	return {
		...
		["Blizzard"] = "Пурга",
		["Block"] = "Блок",
		["Blood Craze"] = "Кровавое бешенство",
		...
		["Challenging Shout"] = "Вызов на бой",
		["Charge"] = "Нападение",
		...
		["Counterspell"] = "Контрчары",
		["Counterspell - Silenced"] = "Контрчары - немота",
		["Cower"] = "Съежиться",
		...
		["Create Healthstone (Major)"] = "Создание здрав-камня (старшего)",
		...
		["Disengage"] = "Отрыв",
		["Dismiss Pet"] = "Освобождение питомца",
		...
		["Drink"] = "Испитие",
		["Dual Wield"] = "Двуручное оружие",
		["Dual Wield Specialization"] = "Специализация - двуручное оружие",
		["Duel"] = "Дуэль",
		...
		["Earthbind"] = "Земляные Оковы",
		["Earthbind Totem"] = "Тотем Земляных Оков",
		["Earthstrike"] = "Земной удар",
		["Efficiency"] = "Эффективность",
		["Elemental Devastation"] = "Опустошение Духов стихии",
		["Elemental Focus"] = "Средоточие Духов стихии",
		["Elemental Fury"] = "ЯростьДухов стихии",
		["Elemental Leatherworking"] = "Кожевенное дело школы Стихии",
		["Elemental Mastery"] = "Власть над Духами стихии",
		["Elemental Precision"] = "Точность Духов стихии",
		["Elemental Sharpening Stone"] = "ТочилоДухов стихии",
		["Elemental Weapons"] = "Оружие Духов стихии",
		...
		["Fire Nova Totem"] = "Тотем Огненной звезды",
		...
		["Flametongue Weapon"] = "Оружие Язык Пламени",
		["Flare"] = "Вспышка",
		...
		["Freezing Trap"] = "Леденящая ловушка",
		["Freezing Trap Effect"] = "Эффект Леденящей ловушки",
		...
		["Grace of Air"] = "Благословение Воздуха",
		["Grace of Air Totem"] = "Тотем Благословения Воздуха",
		...
		["Healing Stream"] = "Целительный поток",
		["Healing Stream Totem"] = "Тотем целительного потока",
		...
		["Improved Ambush"] = "Совершенная засада",
		["Improved Arcane Missiles"] = "Совершенный чародейский снаряд",
		["Improved Arcane Shot"] = "Совершенный чародейский выстрел",
		["Improved Aspect of the Hawk"] = "Совершенный аспект ястреба",
		["Improved Aspect of the Monkey"] = "Совершенный аспект обезъяны",
		["Improved Backstab"] = "Improved Backstab",
		["Improved Barrage"] = "Совершенный заградительный огонь",
		["Improved Berserker Rage"] = "Совершенная ярость берсерка",
		["Improved Blessing of Might"] = "Совершенное благословение мощи",
		["Improved Blessing of Wisdom"] = "Совершенное благословение познания",
		["Improved Blink"] = "Совершенный скачок",
		["Improved Blizzard"] = "Совершенная пурга",
		["Improved Bloodrage"] = "Совершенная ярость крови",
		["Improved Chain Heal"] = "Совершенное последовательное исцеление",
		["Improved Chain Lightning"] = "Совершенная цепь молний",
		["Improved Challenging Shout"] = "Совершенный вызов на бой",
		["Improved Charge"] = "Совершенная атака",
		["Improved Cleave"] = "Совершенный колун",
		["Improved Concentration Aura"] = "Совершенная аура сосредоточения",
		["Improved Concussive Shot"] = "Совершенный контузящий выстрел",
		["Improved Cone of Cold"] = "Совершенный конус холода",
		["Improved Corruption"] = "Совершенная порча",
		["Improved Counterspell"] = "Совершенные контрчары",
		["Improved Curse of Agony"] = "Совершенное проклятие агонии",
		["Improved Curse of Weakness"] = "Совершенное проклятие слабости",
		["Improved Demoralizing Shout"] = "Совершенный устрашающий возглас",
		["Improved Devotion Aura"] = "Совершенная аура преданности",
		["Improved Disarm"] = "Совершенное разоружение",
		["Improved Drain Life"] = "zzOLDСовершенное похищение жизни",
		["Improved Drain Soul"] = "Совершенное похищение души",
		["Improved Enrage"] = "Совершенный прилив ярости",
		["Improved Enslave Demon"] = "Совершенное порабощение демона",
		["Improved Eviscerate"] = "Совершенное потрошение",
		["Improved Execute"] = "Совершенная казнь",
		["Improved Expose Armor"] = "Совершенное ослабление брони",
		["Improved Eyes of the Beast"] = "Совершенный глаз Зверя",
		["Improved Fade"] = "Совершенное сокрытие",
		["Improved Feign Death"] = "Совершенная ложная смерть",
		["Improved Fire Blast"] = "Совершенная огненная вспышка",
		["Improved Fire Totems"] = "Совершенный тотем Огня",
		["Improved Fire Ward"] = "Improved Fire Ward",
		["Improved Fireball"] = "Совершенный огненный шар",
		["Improved Firebolt"] = "Совершенная огненная молния",
		["Improved Flamestrike"] = "Совершенный огненный удар",
		["Improved Flash of Light"] = "Совершенная небесная вспышка",
		["Improved Frost Nova"] = "Совершенная ледяная звезда",
		["Improved Frostbolt"] = "Совершенная ледяная стрела",
		["Improved Ghost Wolf"] = "Совершенный призрачный волк",
		["Improved Gouge"] = "Совершенный парализующий укол",
		["Improved Hammer of Justice"] = "Совершенный молот правосудия",
		["Improved Hamstring"] = "Совершенная подрезка ахиллы",
		["Improved Healing"] = "Совершенное исцеление",
		["Improved Healing Touch"] = "Совершенное целительное прикосновение",
		["Improved Healing Wave"] = "Совершенная волна исцеления",
		["Improved Health Funnel"] = "Совершенный канал здоровья",
		["Improved Healthstone"] = "Совершенный здрав-камень",
		["Improved Heroic Strike"] = "Совершенный удар героя",
		["Improved Holy Shield"] = "Совершенный священный щит",
		["Improved Howl of Terror"] = "Совершенный вой ужаса",
		["Improved Hunter's Mark"] = "Совершенный знак охотника",
		["Improved Immolate"] = "Совершенный Жар Преисподней",
		["Improved Imp"] = "Совершенный бес",
		["Improved Inner Fire"] = "Совершенный внутренний огонь",
		["Improved Intercept"] = "Совершенный перехват",
		["Improved Intimidating Shout"] = "Совершенный запугивающий крик",
		["Improved Judgement"] = "Совершенное провосудие",
		["Improved Kick"] = "Совершенный пинок",
		["Improved Kidney Shot"] = "Совершенный удар по почкам",
		["Improved Lash of Pain"] = "Совершенный всплеск боли",
		["Improved Lay on Hands"] = "Совершенное наложение рук",
		["Improved Leader of the Pack"] = "Совершенный альфа-самец",
		["Improved Life Tap"] = "Совершенный жизнеотвод",
		["Improved Lightning Bolt"] = "Совершенная молния",
		["Improved Lightning Shield"] = "Совершенный щит молний",
		["Improved Magma Totem"] = "Совершенный тотем Магмы",
		["Improved Mana Burn"] = "Совершенное сжигание маны",
		["Improved Mana Shield"] = "Совершенный щит маны",
		["Improved Mana Spring Totem"] = "Совершенный тотем источника маны",
		["Improved Mark of the Wild"] = "Совершенный знак дикой природы",
		["Improved Mend Pet"] = "Совершенное исцеление питомца",
		["Improved Mind Blast"] = "Совершенный вызрыв разума",
		["Improved Moonfire"] = "Совершенный лунный огонь",
		["Improved Mortal Strike"] = "Совершенный убийственный удар",
		["Improved Nature's Grasp"] = "Совершенный природный захват",
		["Improved Overpower"] = "Совершенное превосходство",
		["Improved Power Word: Fortitude"] = "Совершенное слово силы: стойкость",
		["Improved Power Word: Shield"] = "Совершенное слово силы: щит",
		["Improved Prayer of Healing"] = "Совершенная молитва об исцелении",
		["Improved Psychic Scream"] = "Совершенный ментальный крик",
		["Improved Regrowth"] = "Совершенное возрождение",
		["Improved Reincarnation"] = "Совершенное восстание из мертвых",
		["Improved Rejuvenation"] = "Совершенное омоложение",
		["Improved Rend"] = "Совершенный разрыв",
		["Improved Renew"] = "Совершенное обновление",
		["Improved Retribution Aura"] = "Совершенная аура воздаяния",
		["Improved Revenge"] = "Совершенная месть",
		["Improved Revive Pet"] = "Совершенное воскрешение питомца",
		["Improved Righteous Fury"] = "Совершенный праведный гнев",
		["Improved Rupture"] = "Совершенный провал",
		["Improved Scorch"] = "Совершенный ожог",
		["Improved Scorpid Sting"] = "Совершенное жало скорпида",
		["Improved Seal of Righteousness"] = "Совершенная печать праведности",
		["Improved Seal of the Crusader"] = "Совершенная печать воина света",
		["Improved Searing Pain"] = "Совершенная жгучая боль",
		["Improved Serpent Sting"] = "Совершенное жало змеи",
		["Improved Shadow Bolt"] = "Совершенная теневая стрела",
		["Improved Shadow Word: Pain"] = "Совершенное слово Тьмы: боль",
		["Improved Shield Bash"] = "Совершенный удар щитом",
		["Improved Shield Block"] = "Совершенный щитовой блок",
		["Improved Shield Wall"] = "Совершенная стена щитов",
		["Improved Sinister Strike"] = "Совершенный Коварный удар",
		["Improved Slam"] = "Совершенный удар",
		["Improved Slice and Dice"] = "Совершенная мясорубка",
		["Improved Sprint"] = "Совершенный рывок",
		["Improved Stings"] = "Совершенные жала",
		["Improved Succubus"] = "Совершенный суккуб",
		["Improved Sunder Armor"] = "Совершенное расщепление брони",
		["Improved Taunt"] = "Совершенная провокация",
		["Improved Thunder Clap"] = "Совершенный раскат грома",
		["Improved Tranquility"] = "Совершенное спокойствие",
		["Improved Vampiric Embrace"] = "Совершенные вампирские объятия",
		["Improved Vanish"] = "Совершенное исчезновение",
		["Improved Voidwalker"] = "Совершенный демон Хаоса",
		["Improved Weapon Totems"] = "Совершенные тотемы чар",
		["Improved Whirlwind"] = "Совершенный вихрь",
		["Improved Wing Clip"] = "Совершенное сметающее крыло",
		...
		["Poison Cleansing Totem"] = "Тотем Очищения от яда",
		...
		["Rockbiter Weapon"] = "Оружие Камнекуса",
		...
		["Searing Totem"] = "Тотем Испепеления",
		...
		["Track Elementals"] = "Выслеживание духов стихий",
		...
		["Weapon Mastery"] = "Мастерство во владении оружием",
		["Weaponsmith"] = "Оружейник",
		["Well Fed"] = "Сытость",
		["Whirlwind"] = "Смерч",
		["Will of the Forsaken"] = "Воля Отрекшихся",
		["Windfury"] = "Ярость ветра",
		["Windfury Attack"] = "Атака Ярости Ветра",
		["Windfury Totem"] = "Тотем ярости ветра",
		["Windfury Weapon"] = "Оружие ярости ветра",

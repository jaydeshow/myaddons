function TradeLogFrame_OnLoad()
	table.insert(UISpecialFrames, this:GetName()); --for esc close frame
...
function TradeListScrollFrame_Update()
...
StaticPopupDialogs["TRADE_LOG_CLEAR_HISTORY"] = {
	...
	whileDead = 1,
	OnShow = function()
		getglobal(this:GetName().."Text"):SetText(TRADE_LIST_CLEAR_CONFIRM);
	end,
	OnAccept = function()
...
function TradeListFrame_TradeTooltip(trade)

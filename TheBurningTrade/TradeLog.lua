...
function TradeLog_OnLoad()
	local menu = CreateFrame("Frame", "TBT_AnnounceChannelDropDown", TradeFrame, "UIDropDownMenuTemplate");
	menu:SetPoint("BOTTOMLEFT", "TradeFrame", "BOTTOMLEFT", -2, 48);
	menu:SetFrameLevel(1);
	UIDropDownMenu_SetWidth(60, TBT_AnnounceChannelDropDown);
...
--for UI
function TBT_AnnounceChannelDropDown_OnClick()
	UIDropDownMenu_SetSelectedValue(TBT_AnnounceChannelDropDown, this.value);
	TradeLog_AnnounceChannel = this.value;
end

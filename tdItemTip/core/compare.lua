...
GameTooltip1 = CreateTooltip("tdItemTip1", UIParent)
GameTooltip2 = CreateTooltip("tdItemTip2", UIParent)
...
if AtlasLootItem_ShowCompareItem then
	AtlasLootItem_ShowCompareItem = function()
		GameTooltip_ShowCompareItem(AtlasLootTooltip, GameTooltip1, GameTooltip2)
	end
end

function tdItemTip:SetGuildBank()
	self:HookFrameScript(GuildBankMessageFrame, "OnHyperlinkEnter", OnHyperlinkEnter)
	self:HookFrameScript(GuildBankMessageFrame, "OnHyperlinkLeave", OnHyperlinkLeave)

...
AL:RegisterTranslations("frFR", function() return {
    ...
    ["Dungeon 1 Set"] = "Sets Donjon 1",
    ["Dungeon 2 Set"] = "Sets Donjon 2",
    ...
    ["Lvl 70 Instance Token Rewards"] = "Insignes Instances Niv. 70",
    ["Lvl 70 Instance Rewards"] = "Lvl70 Récompenses Héroïques",

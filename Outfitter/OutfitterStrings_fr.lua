if GetLocale() == "frFR" then
	...
	Outfitter.cShowHelm = "Show Helm"
	Outfitter.cShowCloak = "Show Cloak"
	Outfitter.cHideHelm = "Hide Helm"
	Outfitter.cHideCloak = "Hide Cloak"
	...
	Outfitter.cContainerBagSubType = "Conteneur"

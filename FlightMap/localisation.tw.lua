...
FLIGHTMAP_BLADESEDGE    = "劍刃山脈";
FLIGHTMAP_HELLFIRE      = "地獄火半島";
FLIGHTMAP_NAGRAND       = "納葛蘭";
FLIGHTMAP_NETHERSTORM   = "虛空風暴";
FLIGHTMAP_SHADOWMOON    = "影月谷";
FLIGHTMAP_SHATTRATH     = "撒塔斯城";
FLIGHTMAP_TEROKKAR      = "泰洛卡森林";
FLIGHTMAP_ZANGARMARSH   = "贊格沼澤";
FLIGHTMAP_AZUREMYST     = "藍謎島";
FLIGHTMAP_EVERSONG      = "永歌森林t";
FLIGHTMAP_BLOODMYST     = "血謎島";
FLIGHTMAP_GHOSTLANDS    = "鬼魂之地";

...
AtlasLoot_Data["AtlasLootExpansionItems"] = {
    ...
    BCKeys = {
        ...
        { 0,"","","" },
        { 0, "INV_Box_01", "=q6=#j3#", "" },
        { 30622, "INV_Misc_Key_13", "=q1=Flamewrought Key", "=ds=#e9# =ec1=#m7#" },
        { 30637, "INV_Misc_Key_13", "=q1=Flamewrought Key", "=ds=#e9# =ec1=#m6#" },
    ...
    HCRampOmor = {
        ...
        { 24091, "INV_Belt_27", "=q3=Tenacious Defender", "=ds=#s10#, #a4#", "12.67%" },
    ...
    HCRampFelIronChest = {
        ...
        { 24083, "INV_Pants_Plate_01", "=q3=Lifegiver Britches", "=ds=#s11#, #a1#", "17.00%" },
    ...
    HCRampFelIronChestHEROIC = {
        ...
        { 0,"","","" },
        { 27452, "INV_Bracer_13", "=q3=Light Scribe Bands", "=ds=#s8#, #a1#", "11.73%" },
    ...
    HCFurnaceMaker = {
        { 24388, "INV_Belt_31", "=q3=Girdle of the Gale Storm", "=ds=#s10#, #a3#", "15.84%" },
    ...
    HCFurnaceBroggokHEROIC = {
        ...
        { 27490, "INV_Axe_65", "=q3=Firebrand Battleaxe", "=ds=#h1#, #w1#", "9.72%" },
	};
    ...
    HCFurnaceBreakerHEROIC = {
        ...
        { 27514, "INV_Pants_Leather_12", "=q3=Leggings of the Unrepentant", "=ds=#s11#, #a2#", "13.64%" },
        ...
        { 27788, "INV_Boots_Chain_04", "=q3=Bloodsworn Warboots", "=ds=#s12#, #a4#" },
        ...
        { 0,"","","" },
        { 33814, "INV_Staff_Goldfeathered_01", "=q1=Keli'dan's Feathered Stave", "=ds=#m3#", "100%" },
	};
    ...
    CFRSlaveQuagmirran = {
        ...
        { 24363, "INV_Chest_Plate13", "=q3=Unscarred Breastplate", "=ds=#s5#, #a4#", "9.54%" },
    ...
    CFRSlaveQuagmirranHEROIC = {
        ...
        { 27742, "INV_Belt_13", "=q3=Mage-Fury Girdle", "=ds=#s10#, #a1#", "12.00%" },
        { 0,"","","" },
        { 33821, "INV_Misc_Organ_02", "=q1=The Heart of Quagmirran", "=ds=#m3#", "100%" },
        { 0,"","","" },
        { 0,"","","" },
        { 30604, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Resplendent Fire Opal", "=ds=#e7#", "22.49%" },
        { 30605, "INV_Jewelcrafting_Talasite_03", "=q4=Vivid Chrysoprase", "=ds=#e7#", "9.39%" },
    ...
    CFRUnderHungarfen = {
        ...
        { 24452, "INV_Gauntlets_21", "=q3=Starlight Gauntlets", "=ds=#s9#, #a2#", "12.35%" },
        { 24451, "INV_Jewelry_Ring_AhnQiraj_01", "=q3=Lykul Bloodbands", "=ds=#s8#, #a3#", "11.75%" },
        { 24413, "Spell_Nature_Lightning", "=q3=Totem of the Thunderhead", "=ds=#s16#, #w15#", "12.86%" },
    ...
    CFRUnderGhazan = {
        ...
        { 24461, "INV_Mace_21", "=q3=Hatebringer", "=ds=#h2#, #w6#", "14.12%" },
	};
    ...
    CFRUnderSwamplordHEROIC = {
        ...
        { 27762, "INV_Jewelry_Ring_44", "=q3=Weathered Band of the Swamplord", "=ds=#s13#" },
    ...
    CFRUnderStalkerHEROIC = {
        ...
        { 27780, "INV_Jewelry_Ring_31", "=q3=Ring of Fabled Hope", "=ds=#s13#", "9.90%" },
        ...
        { 0,"","","" },
        { 24248, "Spell_Shadow_Brainwash", "=q1=Brain of the Black Stalker", "=ds=#m3#", "100%" },
        { 33826, "INV_Misc_ShadowEgg", "=q1=Black Stalker Egg", "=ds=#m3#", "100%" },
	};
    ...
    AuchManaNexusPrinceHEROIC = {
        ...
        { 0,"","","" },
        { 27831, "INV_Shoulder_17", "=q3=Mantle of the Unforgiven", "=ds=#s3#, #a1#", "9.20%" },
        { 27843, "INV_Belt_10", "=q3=Glyph-Lined Sash", "=ds=#s10#, #a1#", "10.80%" },
        { 27827, "INV_Bracer_06", "=q3=Lucid Dream Bracers", "=ds=#s8#, #a2#" },
        ...
        { 0,"","","" },
        { 33835, "INV_Jewelry_Amulet_07", "=q1=Shaffar's Wondrous Amulet", "=ds=#m3#", "100%" },
        { 28490, "INV_Misc_Bandage_Netherweave", "=q1=Shaffar's Wrappings", "=ds=#m3#", "100%" },
        { 30584, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Enscribed Fire Opal", "=ds=#e7#", "0.08%" },
        { 30585, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Glistening Fire Opal", "=ds=#e7#", "6.06%" },
        { 30583, "INV_Jewelcrafting_Talasite_03", "=q4=Timeless Chrysoprase", "=ds=#e7#", "9.09%" },
    ...
    AuchCryptsExarchHEROIC = {
        ...
        { 21525, "INV_Helmet_68", "=q2=Green Winter Hat", "=ds=#s1#, #a1# =q2=#m28#" },
        { 0,"","","" },
        { 33836, "INV_Misc_Gem_Pearl_07", "=q1=The Exarch's Soul Gem", "=ds=#m3#", "100%" },
        { 0,"","","" },
        { 30587, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Champion's Fire Opal", "=ds=#e7#", "11.67%" },
        { 30588, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Potent Fire Opal", "=ds=#e7#", "1.67%" },
        { 30586, "INV_Jewelcrafting_Talasite_03", "=q4=Seer's Chrysoprase", "=ds=#e7#", "11.67%" },
    ...
    AuchCryptsTrash = {
        { 23605, "INV_Scroll_05", "=q3=Plans: Felsteel Gloves", "=ds=#p2# (360), =q1=#n55#", "0.69%" },
        { 0,"","","" },
    ...
    AuchSethekkTalonKingHEROIC = {
        ...
        { 0,"","","" },
        { 27632, "INV_Spear_11", "=q1=Terokk's Quill", "=ds=#m3#", "100%" },
        { 33834, "INV_Feather_06", "=q1=The Headfeathers of Ikiss", "=ds=#m3#", "100%" },
	};
    ...
    CoTHillsbradSkarloc = {
        ...
        { 27426, "INV_Mace_55", "=q3=Northshire Battlemace", "=ds=#h3#, #w6#", "15.37%" },
        { 0,"","","" },
    ...
    CoTHillsbradHunter = {
        ...
        { 27432, "INV_Jewelry_Ring_53Naxxramas", "=q3=Broxigar's Ring of Valor", "=ds=#s13#", "16.35%" },
    ...
    CoTHillsbradHunterHEROIC = {
        ...
        { 30534, "INV_Pants_Mail_16", "=q4=Wyrmscale Greaves", "=ds=#s11#, #a3#" },
        ...
        { 0,"","","" },
        { 33847, "INV_Misc_Head_Dragon_Black", "=q1=Epoch Hunter's Head", "=ds=#m3#", "100%" },
	};
    ...
    CoTHillsbradThomasYance = {
        { 25725, "INV_Scroll_03", "=q1=Pattern: Riding Crop", "=ds=#p7# (350)" },
	};

    CoTHillsbradAgedDalaranWizard = {
        { 22539, "INV_Misc_Note_01", "=q1=Formula: Enchant Shield - Intellect", "=ds=#p4# (325)" },
	};
    ...
    AuchShadowMurmurHEROIC = {
        ...
        { 0,"","","" },
        { 33840, "INV_Elemental_Mote_Air01", "=q1=Murmur's Whisper", "=ds=#m3#", "100%" },
	};
    ...
    HCHallsNethekurse = {
        ...
        { 27520, "INV_Helmet_71", "=q3=Greathelm of the Unbreakable", "=ds=#s1#, #a4#", "16.47%" },
        { 27518, "Spell_Arcane_Arcane03", "=q3=Ivory Idol of the Moongoddess", "=ds=#s16#, #w14#", "17.42%" },
        { 0,"","","" },
        { 21525, "INV_Helmet_68", "=q2=Green Winter Hat", "=ds=#s1#, #a1# =q2=#m28#" },
        { 0,"","","" },
        { 23735, "INV_Jewelry_Amulet_04", "=q1=Grand Warlock's Amulet", "=ds=#m3#", "100%" },
	};
    ...
    HCHallsNethekurseHEROIC = {
        ...
        { 27520, "INV_Helmet_71", "=q3=Greathelm of the Unbreakable", "=ds=#s1#, #a4#", "11.11%" },
    ...
    HCHallsKargath = {
        ...
        { 27538, "INV_Hammer_23", "=q3=Lightsworn Hammer", "=ds=#h3#, #w6#", "10.6%" },
    ...
    HCHallsKargathHEROIC = {
        ...
        { 29254, "INV_Boots_Chain_05", "=q4=Boots of the Righteous Path", "=ds=#s12#, #a4#" },
        ...
        { 27538, "INV_Hammer_23", "=q3=Lightsworn Hammer", "=ds=#h3#, #w6#", "16.95%" },
        { 27540, "INV_Wand_18", "=q3=Nexus Torch", "=ds=#w12#", "22.03%" },
        { 0,"","","" },
        { 23723, "INV_Weapon_Hand_03", "=q1=Warchief Kargath's Fist", "=ds=#m3#", "100%" },
        { 33815, "INV_SummerFest_Symbol_Medium", "=q1=Bladefist's Seal", "=ds=#m3#", "100%" },
        { 30548, "INV_Jewelcrafting_Talasite_03", "=q4=Polished Chrysoprase", "=ds=#e7#", "0.16%" },
        { 30547, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Luminous Fire Opal", "=ds=#e7#", "0.19%" },
        { 30546, "INV_Jewelcrafting_Nightseye_03", "=q4=Sovereign Tanzanite", "=ds=#e7#", "3.39%" },
        { 0,"","","" },
    ...
    HCHallsExecutioner = {
        { 31716, "INV_Axe_17", "=q1=Unused Axe of the Executioner", "=ds=#m3#", "100%" },
	};
    ...
    CFRSteamWarlordHEROIC = {
        ...
        { 33827, "INV_Misc_Book_05", "=q1=The Warlord's Treatise", "=ds=#m3#", "100%" },
        { 0,"","","" },
        { 24313, "INV_Scroll_05", "=q4=Pattern: Battlecast Hood", "=ds=#p8# (375)", "0.20%" },
        { 30550, "INV_Jewelcrafting_Talasite_03", "=q4=Sundered Chrysoprase", "=ds=#e7#", "8.59%" },
        { 30551, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Infused Fire Opal", "=ds=#e7#", "6.64%" },
    ...
    CoTMorassAeonusHEROIC = {
        ...
        { 0,"","","" },
        { 33858, "INV_Gizmo_KhoriumPowerCore", "=q1=Aeonus's Hourglass", "=ds=#m3#", "100%" },
        { 0,"","","" },
        { 30558, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Glimmering Fire Opal", "=ds=#e7#" },
        { 30556, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Glinting Fire Opal", "=ds=#e7#" },
        { 30555, "INV_Jewelcrafting_Nightseye_03", "=q4=Glowing Tanzanite", "=ds=#e7#" },
    ...
    TKMechCapacitus = {
        ...
        { 0,"","","" },
        { 0, "INV_Scroll_05", "=q3=Schematic: Rocket Boots Xtreme Lite", "=ds=#p5# (375) (Patch 2.4)" },
	};
    ...
    TKMechOverchargedManacell = {
        { 30824, "INV_Gizmo_KhoriumPowerCore", "=q1=Overcharged Manacell", "=ds=#m3#" },
	};
    ...
    TKMechSepethrea = {
        ...
        { 21524, "INV_Helmet_67", "=q2=Red Winter Hat", "=ds=#s1#, #a1# =q2=#m28#" },
        { 0,"","","" },
        { 22920, "INV_Scroll_06", "=q2=Recipe: Major Fire Protection Potion", "=ds=#p1# (360) =q1=#n93#" },
	};
    ...
    TKMechCalcHEROIC = {
        ...
        { 0,"","","" },
        { 33860, "INV_Misc_EngGizmos_08", "=q1=Pathaleon's Projector", "=ds=#m3#", "100%" },
        { 31086, "INV_Misc_Gem_BloodGem_01", "=q1=Bottom Shard of the Arcatraz Key", "=ds=#m3#", "100%" },
	};
    ...
    TKBotFreywinn = {
        ...
        { 21524, "INV_Helmet_67", "=q2=Red Winter Hat", "=ds=#s1#, #a1# =q2=#m28#" },
        { 0,"","","" },
        { 31744, "INV_Misc_Book_07", "=q1=Botanist's Field Guide", "=ds=#m3#", "100%" },
	};
    ...
    TKBotSplinterHEROIC = {
        ...
        { 0,"","","" },
        { 31085, "INV_Misc_Gem_AzureDraenite_01", "=q1=Top Shard of the Arcatraz Key", "=ds=#m3#", "100%" },
        { 33859, "INV_Misc_Branch_01", "=q1=Warp Splinter Clipping", "=ds=#m3#", "100%" },
	};
    ...
    TKArcHarbingerHEROIC = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 29241, "INV_Belt_03", "=q4=Belt of Depravity", "=ds=#s10#, #a1#", "8.47%" },
        ...
        { 0,"","","" },
        { 33861, "INV_Misc_SymbolofKings_01", "=q1=The Scroll of Skyriss", "=ds=#m3#", "100%" },
        { 0,"","","" },
        { 30582, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Deadly Fire Opal", "=ds=#e7#", "0.18%" },
        { 30575, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Nimble Fire Opal", "=ds=#e7#", "0.18%" },
        { 30581, "INV_Jewelcrafting_NobleTopaz_03", "=q4=Durable Fire Opal", "=ds=#e7#", "0.18%" },
    ...
    KaraKeannaLog = {
        { 24492, "INV_Misc_Book_06", "=q1=Keanna's Log", "=ds=#m3#" },
	};
    ...
    KaraOperaEvent = {
        ...
        { 28579, "INV_Poison_MindNumbing", "=q4=Romulo's Poison Vial", "=ds=#s14#", "29.54%" },
    ...
    KaraIllhoof = {
        ...
        { 28657, "INV_Weapon_Shortblade_44", "=q4=Fool's Bane", "=ds=#h1#, #w6#", "14.63%" },
    ...
    KaraPrince = {
        ...
        { 28767, "INV_Axe_66", "=q4=The Decapitator", "=ds=#h1#, #w1#", "15.43%" },
    ...
    KaraTrash = {
        ...
        { 0,"","","" },
        { 23857, "INV_Misc_Book_07", "=q1=Legacy of the Mountain King", "=ds=" },
        { 23864, "INV_Misc_Book_07", "=q1=Torment of the Worgen", "=ds=" },
        { 23862, "INV_Misc_Book_07", "=q1=Redemption of the Fallen", "=ds=" },
        { 23865, "INV_Misc_Book_07", "=q1=Wrath of the Titans", "=ds=" },
        { 0,"","","" },
        { 21882, "Spell_Shadow_SoulLeech_3", "=q1=Soul Essence", "=ds=#e8#" },
        { 0,"","","" },
        { 30666, "INV_Jewelry_Necklace_30Naxxramas", "=q4=Ritssyn's Lost Pendant", "=ds=#s2#", "0.18%" },
    ...
    HCMagtheridon = {
        ...
        { 0,"","","" },
        { 34845, "INV_Misc_Bag_EnchantedRunecloth", "=q4=Pit Lord's Satchel", "=ds=#e1# #m15# (Patch 2.4)" },
	};
    ...
    CFRSerpentTrash = {
        ...
        { 0,"","","" },
        { 30183, "INV_Elemental_Mote_Nether", "=q4=Nether Vortex", "=ds=#e8#" },
        { 0,"","","" },
    ...
    TKEyeVoidReaver = {
        { 29986, "INV_Helmet_14", "=q4=Cowl of the Grand Engineer", "=ds=#s1#, #a1#" },
    ...
    MountHyjalAnetheron = {
        ...
        { 30883, "Inv_Staff_60", "=q4=Pillar of Ferocity", "=ds=#w9#" },
    ...
    MountHyjalTrash = {
        ...
        { 34010, "Inv_Misc_Cape_16", "=q4=Pepe's Shroud of Pacification","=ds=#s4#" },
        ...
        { 32589, "INV_Jewelry_Necklace_17", "=q4=Hellfire-Encased Pendant", "=ds=#s2#" },
        { 34009, "Inv_Mace_57", "=q4=Hammer of Judgement","=ds=#h3#, #w6#" },
        { 32946, "INV_Weapon_Hand_14", "=q4=Claw of Molten Fury", "=ds=#h3#, #w13#" },
        { 32945, "INV_Weapon_Hand_14", "=q4=Fist of Molten Fury", "=ds=#h2#, #w13#" },
        { 0,"","","" },
        ...
        { 32297, "Inv_Scroll_04", "=q4=Design: Sovereign Shadowsong Amethyst", "=ds=#p12# (375)" },
    ...
    BTNajentus = {
        ...
        { 32377, "Inv_Shoulder_67", "=q4=Mantle of Darkness", "=ds=#s3#, #a2#" },
        ...
        { 32248, "INV_Weapon_Halberd_20", "=q4=Halberd of Desolation", "=ds=#w7#" },
	};

    BTSupremus = {
        { 32256, "Inv_Belt_03", "=q4=Waistwrap of Infinity", "=ds=#s10#, #a1#" },
        { 32252, "Inv_Chest_Leather_03", "=q4=Nether Shadow Tunic", "=ds=#s5#, #a2#" },
    ...
    BTShahraz = {
        ...
        { 32366, "INV_Boots_Cloth_02", "=q4=Shadowmaster's Boots", "=ds=#s12#, #a2#" },
    ...
    BTCouncil = {
        ...
        { 32373, "INV_Helmet_98", "=q4=Helm of the Illidari Shatterer", "=ds=#s1#, #a4#" },
        { 32505, "Spell_Shadow_Charm", "=q4=Madness of the Betrayer", "=ds=#s14#" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
    ...
    BTTrash = {
        { 32590, "INV_Misc_Cape_10", "=q4=Nethervoid Cloak", "=ds=#s4#" },
        { 34012, "Inv_Misc_Cape_16", "=q4=Shroud of the Final Stand","=ds=#s4#" },
        { 32609, "INV_Boots_Cloth_08", "=q4=Boots of the Divine Light", "=ds=#s12#, #a1#" },
        { 32593, "INV_Boots_Wolf", "=q4=Treads of the Den Mother", "=ds=#s12#, #a2#" },
        { 32592, "Inv_Chest_Chain_11", "=q4=Chestguard of Relentless Storms", "=ds=#s5#, #a3#" },
        { 32608, "Inv_Gauntlets_62", "=q4=Pillager's Gauntlets", "=ds=#s9#, #a4#" },
        ...
        { 34011, "Inv_Shield_01", "=q4=Illidari Runeshield", "=ds=#w8#" },
        { 0,"","","" },
    ...
    BTPatterns = {
        ...
        { 32751, "INV_Scroll_04", "=q4=Pattern: Living Earth Shoulders", "=ds=#p7# (375)" },
        { 32749, "Inv_Scroll_04", "=q4=Pattern: Shoulders of Lightning Reflexes", "=ds=#p7# (375)" },
        { 32745, "INV_Scroll_04", "=q4=Pattern: Shoulderpads of Renewed Life", "=ds=#p7# (375)" },
        ...
        { 0,"","","" },
        { 0,"","","" },
        { 32754, "INV_Scroll_04", "=q4=Pattern: Bracers of Nimble Thought", "=ds=#p8# (375)" },
    ...
    ZANalorakk = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 33203, "INV_Chest_Cloth_35", "=q4=Robes of Heavenly Purpose", "=ds=#s5#, #a1#" },
        { 33285, "INV_Bracer_13", "=q4=Fury of the Ursine", "=ds=#s8#, #a1#" },
        { 33211, "INV_Belt_14", "=q4=Bladeangel's Money Belt", "=ds=#s10#, #a2#" },
        { 33206, "INV_Shoulder_85", "=q4=Pauldrons of Primal Fury", "=ds=#s3#, #a3#" },
        { 33327, "INV_Mask_02", "=q4=Mask of Introspection", "=ds=#s1#, #a4#" },
        { 33191, "INV_Boots_Plate_10", "=q4=Jungle Stompers", "=ds=#s12#, #a4#" },
        { 33640, "INV_Weapon_Hand_15", "=q4=Fury", "=ds=#h4#, #w13#" },
        { 0,"","","" },
        { 33307, "Inv_Misc_Note_01", "=q3=Formula: Enchant Weapon - Executioner","=ds=#p4# (375)" },
	};

    ZAAkilZon = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 33286, "INV_Helmet_116", "=q4=Mojo-mender's Mask", "=ds=#s1#, #a3#" },
        { 33215, "INV_CHEST_PLATE_22", "=q4=Bloodstained Elven Battlevest", "=ds=#s5#, #a4#" },
        { 33216, "INV_CHEST_PLATE_22", "=q4=Chestguard of Hidden Purpose", "=ds=#s5#, #a4#" },
        { 33281, "INV_Jewelry_Necklace_AhnQiraj_03", "=q4=Brooch of Nature's Mercy", "=ds=#s2#" },
        { 33293, "INV_Jewelry_Ring_68", "=q4=Signet of Ancient Magics", "=ds=#s13#" },
        { 33214, "INV_Sword_108", "=q4=Akil'zon's Talonblade", "=ds=#h1#, #w10#" },
        { 33283, "INV_Mace_32", "=q4=Amani Punisher", "=ds=#h3#, #w6#" },
        { 0,"","","" },
        { 33307, "Inv_Misc_Note_01", "=q3=Formula: Enchant Weapon - Executioner","=ds=#p4# (375)" },
	};
    ...
    ZAJanAlai = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 33357, "INV_Boots_05", "=q4=Footpads of Madness", "=ds=#s12#, #a1#" },
        { 33356, "INV_Helmet_112", "=q4=Helm of Natural Regeneration", "=ds=#s1#, #a2#" },
        { 33329, "INV_Chest_Leather_06", "=q4=Shadowtooth Trollskin Cuirass", "=ds=#s5#, #a2#" },
        { 33328, "INV_Chest_Chain_13", "=q4=Arrow-fall Chestguard", "=ds=#s5#, #a3#" },
        { 33354, "INV_Weapon_Shortblade_64", "=q4=Wub's Cursed Hexblade", "=ds=#h3#, #w4#" },
        { 33326, "INV_Shield_42", "=q4=Bulwark of the Amani Empire", "=ds=#w8#" },
        { 33332, "INV_Shield_43", "=q4=Enamelled Disc of Mojo", "=ds=#w8#" },
        { 0,"","","" },
        { 33307, "Inv_Misc_Note_01", "=q3=Formula: Enchant Weapon - Executioner","=ds=#p4# (375)" },
	};
    ...
    ZAHalazzi = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 33317, "INV_Chest_Cloth_18", "=q4=Robe of Departed Spirits", "=ds=#s5#, #a1#" },
        { 33300, "INV_Shoulder_24", "=q4=Shoulderpads of Dancing Blades", "=ds=#s3#, #a2#" },
        { 33322, "INV_Chest_Leather_01", "=q4=Shimmer-pelt Vest", "=ds=#s5#, #a2#" },
        { 33533, "INV_Pants_Mail_26", "=q4=Avalanche Leggings", "=ds=#s11#, #a3#" },
        { 33299, "INV_Shoulder_84", "=q4=Spaulders of the Advocate", "=ds=#s3#, #a4#" },
        { 33303, "INV_Boots_Plate_10", "=q4=Skullshatter Warboots", "=ds=#s12#, #a4#" },
        { 33297, "INV_Jewelry_Necklace_19", "=q4=The Savage's Choker", "=ds=#s2#" },
        { 0,"","","" },
        { 33307, "Inv_Misc_Note_01", "=q3=Formula: Enchant Weapon - Executioner","=ds=#p4# (375)" },
	};
    ...
    ZAMalacrass = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 33592, "INV_Misc_Cape_16", "=q4=Cloak of Ancient Rituals", "=ds=#s4#" },
        { 33453, "INV_Helmet_53", "=q4=Hood of Hexing", "=ds=#s1#, #a1#" },
        { 33463, "INV_Helmet_116", "=q4=Hood of the Third Eye", "=ds=#s1#, #a1#" },
        { 33432, "INV_Helmet_113", "=q4=Coif of the Jungle Stalker", "=ds=#s1#, #a3#" },
        { 33464, "INV_Shoulder_86", "=q4=Hex Lord's Voodoo Pauldrons", "=ds=#s3#, #a3#" },
        { 33421, "INV_Helmet_111", "=q4=Battleworn Tuskguard", "=ds=#s1#, #a4#" },
        { 33446, "INV_Belt_27", "=q4=Girdle of Stromgarde's Hope", "=ds=#s10#, #a4#" },
        { 0,"","","" },
        { 33307, "Inv_Misc_Note_01", "=q3=Formula: Enchant Weapon - Executioner","=ds=#p4# (375)" },
        { 0,"","","" },
        { 0,"","","" },
        ...
        { 0,"","","" },
        { 0,"","","" },
        { 33829, "INV_Misc_Head_Troll_01", "=q4=Hex Shrunken Head", "=ds=#s14#" },
        { 34029, "Inv_Helm_Mask_ZulGurub_D_01", "=q4=Tiny Voodoo Mask", "=ds=#s14#" },
        { 33828, "INV_Offhand_Stratholme_A_01", "=q4=Tome of Diabolic Remedy", "=ds=#s14#" },
        { 33389, "INV_Weapon_Shortblade_60", "=q4=Dagger of Bad Mojo", "=ds=#h1#, #w4#" },
        { 33298, "INV_Weapon_Shortblade_65", "=q4=Prowler's Strikeblade", "=ds=#h1#, #w4#" },
        { 33388, "INV_SWORD_107", "=q4=Heartless", "=ds=#h1#, #w10#" },
        { 33465, "INV_Staff_12", "=q4=Staff of Primal Fury", "=ds=#w9#" },
	};

    ZAZuljin = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 33471, "INV_Boots_Fabric_01", "=q4=Two-toed Sandals", "=ds=#s12#, #a1#" },
        { 33479, "INV_Helmet_116", "=q4=Grimgin Faceguard", "=ds=#s1#, #a2#" },
        { 33469, "INV_Chest_Mail_05", "=q4=Hauberk of the Empire's Champion", "=ds=#s5#, #a3#" },
        { 33473, "INV_CHEST_PLATE_22", "=q4=Chestguard of the Warlord", "=ds=#s5#, #a4#" },
        { 33466, "INV_Jewelry_Necklace_04", "=q4=Loop of Cursed Bones", "=ds=#s2#" },
        { 33830, "INV_Trinket_Naxxramas05", "=q4=Ancient Aqir Artifact", "=ds=#s14#" },
        { 33831, "RACIAL_TROLL_BERSERK", "=q4=Berserker's Call", "=ds=#s14#" },
        { 0,"","","" },
        { 33307, "Inv_Misc_Note_01", "=q3=Formula: Enchant Weapon - Executioner","=ds=#p4# (375)" },
        { 0,"","","" },
        { 0,"","","" },
        ...
        { 0,"","","" },
        { 0,"","","" },
        { 33467, "INV_Sword_109", "=q4=Blade of Twisted Visions", "=ds=#h3#, #w10#" },
        { 33478, "INV_Sword_108", "=q4=Jin'rohk, The Great Apocalypse", "=ds=#h2#, #w10#" },
        { 33476, "INV_Axe_84", "=q4=Cleaver of the Unforgiving", "=ds=#h1#, #w1#" },
        { 33468, "INV_Staff_64", "=q4=Dark Blessing", "=ds=#h3#, #w6#" },
        { 33474, "INV_Weapon_Bow_32", "=q4=Ancient Amani Longbow", "=ds=#w2#" },
        { 0,"","","" },
        { 33102, "INV_Potion_20", "=q4=Blood of Zul'Jin", "=ds=#m2#" },
	};

    ZATimedChest = {
        { 0, "INV_Box_01", "=q6=#x30#", "" },
        { 33590, "INV_Misc_Cape_20", "=q4=Cloak of Fiends", "=ds=#s4#" },
        { 33591, "INV_Misc_Cape_19", "=q4=Shadowcaster's Drape", "=ds=#s4#" },
        { 33489, "INV_Shoulder_82", "=q4=Mantle of Ill Intent", "=ds=#s3#, #a1#" },
        { 33480, "INV_Belt_24", "=q4=Cord of Braided Troll Hair", "=ds=#s10#, #a1#" },
        { 33483, "INV_Belt_11", "=q4=Life-step Belt", "=ds=#s10#, #a2#" },
        { 33971, "INV_Pants_Leather_23", "=q4=Elunite Imbued Leggings", "=ds=#s11#, #a2#" },
        { 33805, "INV_Boots_Chain_08", "=q4=Shadowhunter's Treads", "=ds=#s12#, #a3#" },
        { 33481, "INV_Shoulder_81", "=q4=Pauldrons of Stone Resolve", "=ds=#s3#, #a4#" },
        { 0, "INV_Box_01", "=q6=#x32#", "" },
        { 33497, "INV_Jewelry_Ring_50Naxxramas", "=q4=Mana Attuned Band", "=ds=#s13#" },
        { 33500, "INV_Jewelry_Ring_61", "=q4=Signet of Eternal Life", "=ds=#s13#" },
        { 33496, "INV_Jewelry_Ring_44", "=q4=Signet of Primal Wrath", "=ds=#s13#" },
        { 33499, "INV_Jewelry_Ring_67", "=q4=Signet of the Last Defender", "=ds=#s13#" },
        { 33498, "INV_Jewelry_Ring_37", "=q4=Signet of the Quiet Forest", "=ds=#s13#" },
        { 0, "INV_Box_01", "=q6=#x31#", "" },
        { 33495, "INV_Weapon_Hand_15", "=q4=Rage", "=ds=#h3#, #w13#" },
        { 33493, "INV_Weapon_Shortblade_66", "=q4=Umbral Shiv", "=ds=#h1#, #w4#" },
        { 33492, "INV_Axe_85", "=q4=Trollbane", "=ds=#h2#, #w1#" },
        { 33490, "INV_Staff_63", "=q4=Staff of Dark Mending", "=ds=#w9#" },
        { 33494, "INV_Staff_08", "=q4=Amani Divining Staff", "=ds=#w9#" },
        { 33491, "INV_Weapon_Rifle_24", "=q4=Tuskbreaker", "=ds=#w5#" },
        { 0,"","","" },
        { 0, "INV_Box_01", "=q6=#x33#", "" },
        { 33809, "Ability_Druid_ChallangingRoar", "=q4=Amani War Bear", "=ds=#e12#" },
	};

    ZATrash = {
        { 33993, "INV_Misc_Toy_02", "=q3=Mojo", "=ds=#e13#" },
        { 0,"","","" },
        { 33865, "INV_Wand_22", "=q2=Amani Hex Stick", "=ds=#m20#" },
        { 33930, "INV_Misc_Idol_03", "=q2=Amani Charm of the Bloodletter", "=ds=#m26#" },
        { 33932, "INV_Misc_Idol_03", "=q2=Amani Charm of the Witch Doctor", "=ds=#m26#" },
        { 33931, "INV_Misc_Idol_03", "=q2=Amani Charm of Mighty Mojo", "=ds=#m26#" },
        { 33933, "INV_Misc_Idol_03", "=q2=Amani Charm of the Raging Defender", "=ds=#m26#" },
	};
    ...
    SMTFireheart = {
        { 34702, "INV_Misc_Cape_19", "=q3=Cloak of Swift Mending", "=ds=#s4#" },
        { 34697, "INV_Bracer_13", "=q3=Binding of Raging Fire", "=ds=#s8#, #a1#" },
        { 34698, "INV_Bracer_16", "=q3=Bracers of the Forest Stalker", "=ds=#s8#, #a3#" },
        { 34701, "INV_Pants_06", "=q3=Leggings of the Betrayed", "=ds=#s11#, #a3#" },
        { 34700, "INV_Gauntlets_26", "=q3=Gauntlets of Divine Blessings", "=ds=#s9#, #a4#" },
        { 34699, "INV_Axe_02", "=q3=Sun-forged Cleaver", "=ds=#h1#, #w1#" },
        { 0,"","","" },
        { 35275, "INV_Misc_Orb_02", "=q3=Orb of the Sin'dorei", "=ds=#m20#" },
	};

    SMTFireheartHEROIC = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 34602, "INV_Bracer_02", "=q4=Eversong Cuffs", "=ds=#s8#, #a2#" },
        { 34601, "INV_Shoulder_27", "=q4=Shoulderplates of Everlasting Pain", "=ds=#s3#, #a4#" },
        { 34604, "INV_Weapon_Shortblade_54", "=q4=Jaded Crystal Dagger", "=ds=#h3#, #w4#" },
        { 34603, "INV_ThrowingKnife_01", "=q4=Distracting Blades", "=ds=#w11#" },
        { 0,"","","" },
        { 34702, "INV_Misc_Cape_19", "=q3=Cloak of Swift Mending", "=ds=#s4#" },
        { 34697, "INV_Bracer_13", "=q3=Binding of Raging Fire", "=ds=#s8#, #a1#" },
        { 34698, "INV_Bracer_16", "=q3=Bracers of the Forest Stalker", "=ds=#s8#, #a3#" },
    ...
    SMTVexallus = {
        { 34708, "INV_Misc_Cape_06", "=q3=Cloak of the Coming Night", "=ds=#s4#" },
        { 34705, "INV_Bracer_13", "=q3=Bracers of Divine Infusion", "=ds=#s8#, #a1#" },
        { 34707, "INV_Boots_05", "=q3=Boots of Resuscitation", "=ds=#s12#, #a2#" },
        { 34704, "INV_Jewelry_Ring_55", "=q3=Band of Arcane Alacrity", "=ds=#s13#" },
        { 34706, "INV_Jewelry_Ring_54", "=q3=Band of Determination", "=ds=#s13#" },
        { 34703, "INV_Sword_76", "=q3=Latro's Dancing Blade", "=ds=#h1#, #w10#" },
	};

    SMTVexallusHEROIC = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 34607, "INV_Shoulder_25", "=q4=Fel-tinged Mantle", "=ds=#s3#, #a1#" },
        { 34605, "INV_Chest_Chain_15", "=q4=Breastplate of Fierce Survival", "=ds=#s5#, #a4#" },
        { 34606, "INV_knife_1h_stratholme_d_03", "=q4=Edge of Oppression", "=ds=#h1#, #w4#" },
        { 34608, "INV_Staff_47", "=q4=Rod of the Blazing Light", "=ds=#w9#" },
        { 0,"","","" },
        { 34708, "INV_Misc_Cape_06", "=q3=Cloak of the Coming Night", "=ds=#s4#" },
        { 34705, "INV_Bracer_13", "=q3=Bracers of Divine Infusion", "=ds=#s8#, #a1#" },
        { 34707, "INV_Boots_05", "=q3=Boots of Resuscitation", "=ds=#s12#, #a2#" },
    ...
    SMTDelrissa = {
        { 34792, "INV_Misc_Cape_18", "=q3=Cloak of the Betrayed", "=ds=#s4#" },
        { 34788, "INV_Shoulder_24", "=q3=Duskhallow Mantle", "=ds=#s3#, #a1#" },
        { 34791, "INV_Gauntlets_12", "=q3=Gauntlets of the Tranquil Waves", "=ds=#s9#, #a3#" },
        { 34789, "INV_Bracer_15", "=q3=Bracers of Slaughter", "=ds=#s8#, #a4#" },
        { 34790, "INV_Mace_34", "=q3=Battle-mace of the High Priestess", "=ds=#h1#, #w6#" },
        { 34783, "INV_Weapon_ShortBlade_14", "=q3=Nightstrike", "=ds=#w11#" },
        { 0,"","","" },
        { 35756, "INV_Misc_Note_01", "=q3=Formula: Enchant Cloak - Steelweave", "=ds=#p4# (375)" },
        { 35275, "INV_Misc_Orb_02", "=q3=Orb of the Sin'dorei", "=ds=#m20#" },
	};

    SMTDelrissaHEROIC = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 34473, "INV_Misc_Idol_05", "=q4=Commendation of Kael'thas", "=ds=#s14#" },
        { 34471, "INV_Potion_106", "=q4=Vial of the Sunwell", "=ds=#s14#" },
        { 34470, "INV_Misc_Gem_LionsEye_01", "=q4=Timbal's Focusing Crystal", "=ds=#s14#" },
        { 34472, "INV_Misc_Rune_04", "=q4=Shard of Contempt", "=ds=#s14#" },
        { 0,"","","" },
        { 34792, "INV_Misc_Cape_18", "=q3=Cloak of the Betrayed", "=ds=#s4#" },
        { 34788, "INV_Shoulder_24", "=q3=Duskhallow Mantle", "=ds=#s3#, #a1#" },
        { 34791, "INV_Gauntlets_12", "=q3=Gauntlets of the Tranquil Waves", "=ds=#s9#, #a3#" },
    ...
    SMTKaelthas = {
        { 34810, "INV_Misc_Cape_20", "=q4=Cloak of Blade Turning", "=ds=#s4#" },
        { 34808, "INV_Gauntlets_19", "=q4=Gloves of Arcane Acuity", "=ds=#s9#, #a1#" },
        { 34809, "INV_Boots_07", "=q4=Sunrage Treads", "=ds=#s12#, #a2#" },
        { 34799, "INV_Chest_Chain_17", "=q4=Hauberk of the War Bringer", "=ds=#s5#, #a3#" },
        { 34807, "INV_Boots_Plate_01", "=q4=Sunstrider Warboots", "=ds=#s12#, #a4#" },
        { 34625, "INV_Jewelry_Ring_42", "=q4=Kharmaa's Ring of Fate", "=ds=#s13#" },
        { 0,"","","" },
        { 35311, "INV_Scroll_05", "=q3=Schematic: Mana Potion Injector", "=ds=#p5# (345)" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        ...
        { 0,"","","" },
        { 0,"","","" },
        { 34793, "INV_Belt_07", "=q3=Cord of Reconstruction", "=ds=#s10#, #a1#" },
        { 34796, "INV_Chest_Cloth_07", "=q3=Robes of Summer Flame", "=ds=#s5#, #a2#" },
        { 34795, "INV_Helmet_03", "=q3=Helm of Sanctification", "=ds=#s1#, #a4#" },
        { 34798, "INV_Jewelry_Ring_16", "=q3=Band of Celerity", "=ds=#s13#" },
        { 34794, "INV_Axe_69", "=q3=Axe of Shattered Dreams", "=ds=#h2#, #w1#" },
        { 34797, "INV_Staff_39", "=q3=Sun-infused Focus Staff", "=ds=#w9#" },
        { 35504, "INV_Misc_PheonixPet_01", "=q3=Phoenix Hatchling", "=ds=#e13#" },
        };

    SMTKaelthasHEROIC = {
        { 29434, "Spell_Holy_ChampionsBond", "=q4=Badge of Justice", "=ds=#e15#", "100%" },
        { 34610, "INV_Bracer_15", "=q4=Scarlet Sin'dorei Robes", "=ds=#s5#, #a1#" },
        { 34613, "INV_Shoulder_07", "=q4=Shoulderpads of the Silvermoon Retainer", "=ds=#s3#, #a2#" },
        { 34614, "INV_Chest_Chain_06", "=q4=Tunic of the Ranger Lord", "=ds=#s5#, #a3#" },
        { 34615, "INV_Chest_Plate02", "=q4=Netherforce Chestplate", "=ds=#s5#, #a4#" },
        { 34612, "INV_Boots_Chain_05", "=q4=Greaves of the Pentinent Knight", "=ds=#s12#, #a4#" },
        { 34611, "INV_Mace_31", "=q4=Cudgel of Consecration", "=ds=#h3#, #w6#" },
        { 34609, "INV_Sword_64", "=q4=Quickening Blade of the Prince", "=ds=#h1#, #w10#" },
        { 34616, "INV_Axe_62", "=q4=Breeching Comet", "=ds=#h1#, #w1#" },
        { 34810, "INV_Misc_Cape_20", "=q4=Cloak of Blade Turning", "=ds=#s4#" },
        { 34808, "INV_Gauntlets_19", "=q4=Gloves of Arcane Acuity", "=ds=#s9#, #a1#" },
        { 34809, "INV_Shoulder_23", "=q4=Sunrage Shoulderpads", "=ds=#s3#, #a2#" },
        { 34799, "INV_Chest_Chain_17", "=q4=Hauberk of the War Bringer", "=ds=#s5#, #a3#" },
        { 34807, "INV_Boots_Plate_01", "=q4=Sunstrider Warboots", "=ds=#s12#, #a4#" },
        { 34625, "INV_Jewelry_Ring_42", "=q4=Kharmaa's Ring of Fate", "=ds=#s13#" },
        { 35513, "Ability_Mount_CockatriceMountElite_Green", "=q4=Swift White Hawkstrider", "=ds=#e12#" },
        { 0,"","","" },
        { 34793, "INV_Belt_07", "=q3=Cord of Reconstruction", "=ds=#s10#, #a1#" },
        { 34796, "INV_Chest_Cloth_07", "=q3=Robes of Summer Flame", "=ds=#s5#, #a2#" },
        { 34795, "INV_Helmet_03", "=q3=Helm of Sanctification", "=ds=#s1#, #a4#" },
    ...
    SMTTrash = {
        { 35516, "INV_Misc_Bag_13", "=q3=Sun Touched Satchel", "=ds=#e1# #m15#" },
	};
    ...
    SPKalecgos = {
        { 34170, "INV_Pants_Cloth_07", "=q4=Pantaloons of Calming Strife", "=ds=#s11#, #a1#" },
		{ 34386, "INV_Pants_Cloth_14", "=q4=Pantaloons of Growing Strife", "=ds=#m29#" },
        { 34169, "INV_Pants_Leather_23", "=q4=Breeches of Natural Aggression", "=ds=#s11#, #a2#" },
        { 34384, "INV_Pants_Leather_23", "=q4=Breeches of Natural Splendor", "=ds=#m29#" },
        { 34168, "INV_Pants_Mail_16", "=q4=Starstalker Legguards", "=ds=#s11#, #a3#" },
        { 34167, "INV_Pants_Plate_22", "=q4=Legplates of the Holy Juggernaut", "=ds=#s11#, #a4#" },
        { 34382, "INV_Pants_Plate_19", "=q4=Judicator's Leggings", "=ds=#m29#" },
        { 34166, "INV_Jewelry_Ring_57", "=q4=Band of Lucent Beams", "=ds=#s13#" },
        { 34165, "INV_Weapon_Shortblade_74", "=q4=Fang of Kalecgos", "=ds=#h1#, #w4#" },
        { 34164, "INV_Sword_115", "=q4=Dragonscale-Encrusted Longblade", "=ds=#h1#, #w10#" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 34848, "INV_Bracer_16", "=q4=Bracers of the Forgotten Conqueror", "=ds=#m23# #e15#" },
        { 34851, "INV_Bracer_17", "=q4=Bracers of the Forgotten Protector", "=ds=#m23# #e15#" },
        { 34852, "INV_Bracer_15", "=q4=Bracers of the Forgotten Vanquisher", "=ds=#m23# #e15#" },
	};

    SPBrutallus = {
        { 34181, "INV_Pants_Cloth_05", "=q4=Leggings of Calamity", "=ds=#s11#, #a1#" },
        { 34180, "INV_Pants_Plate_24", "=q4=Felfury Legplates", "=ds=#s11#, #a4#" },
        { 34381, "INV_Pants_Plate_21", "=q4=Felstrength Legplates", "=ds=#m29#" },
        { 34178, "INV_Jewelry_Necklace_47", "=q4=Collar of the Pit Lord", "=ds=#s2#" },
        { 34177, "INV_Jewelry_Necklace_43", "=q4=Clutch of Demise", "=ds=#s2#" },
        { 34179, "INV_Offhand_Sunwell_D_02", "=q4=Heart of the Pit", "=ds=#s15#" },
        { 34176, "INV_Mace_73", "=q4=Reign of Misery", "=ds=#h3#, #w6#" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        ...
        { 0,"","","" },
        { 0,"","","" },
        { 34853, "INV_Belt_31", "=q4=Belt of the Forgotten Conqueror", "=ds=#m23# #e15#" },
        { 34854, "INV_Belt_33", "=q4=Belt of the Forgotten Protector", "=ds=#m23# #e15#" },
        { 34855, "INV_Belt_27", "=q4=Belt of the Forgotten Vanquisher", "=ds=#m23# #e15#" },
	};

    SPFelmyst = {
        { 34211, "INV_Chest_Leather_14", "=q4=Harness of Carnal Instinct", "=ds=#s5#, #a2#" },
        { 34397, "INV_Chest_Leather_16", "=q4=Bladed Chaos Tunic", "=ds=#m29#" },
        { 34188, "INV_Pants_Leather_27", "=q4=Leggings of the Immortal Night", "=ds=#s11#, #a2#" },
        { 34385, "INV_Pants_Leather_23", "=q4=Leggings of the Immortal Beast", "=ds=#m29#" },
        { 34186, "INV_Pants_Mail_15", "=q4=Chain Links of the Tumultuous Storm", "=ds=#s11#, #a3#" },
        { 34383, "INV_Pants_Mail_15", "=q4=Kilt of Spiritual Reconstruction", "=ds=#m29#" },
        { 34184, "INV_Jewelry_Necklace_44", "=q4=Brooch of the Highborne", "=ds=#s2#" },
        { 34185, "INV_Shield_53", "=q4=Sword Breaker's Bulwark", "=ds=#w8#" },
        { 34182, "INV_Staff_74", "=q4=Grand Magister's Staff of Torrents", "=ds=#w9#" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
        { 0,"","","" },
		{ 0,"","","" },
        { 34856, "INV_Boots_Plate_06", "=q4=Boots of the Forgotten Conqueror", "=ds=#m23# #e15#" },
        { 34857, "INV_Boots_Plate_04", "=q4=Boots of the Forgotten Protector", "=ds=#m23# #e15#" },
        { 34858, "INV_Boots_Plate_07", "=q4=Boots of the Forgotten Vanquisher", "=ds=#m23# #e15#" },
	};
	
    SPEredarTwins = {
		{ 34205, "INV_Misc_Cape_06", "=q4=Shroud of Redeemed Souls", "=ds=#s4#" },
		{ 34190, "INV_Misc_Cape_18", "=q4=Crimson Paragon's Cover", "=ds=#s4#" },
		{ 34210, "INV_Shoulder_02", "=q4=Amice of the Convoker", "=ds=#s3#, #a1#" },
		{ 34202, "INV_Shoulder_25", "=q4=Shawl of Wonderment", "=ds=#s3#, #a1#" },
		{ 34393, "INV_Shoulder_25", "=q4=Shoulderpads of Knowledge's Pursuit", "=ds=#s3#, #a1#" },
		{ 34209, "INV_Shoulder_88", "=q4=Spaulders of Reclamation", "=ds=#s3#, #a2#" },
		{ 34195, "INV_Shoulder_88", "=q4=Shoulderpads of Vehemence", "=ds=#s3#, #a2#" },
		{ 34392, "INV_Shoulder_88", "=q4=Demontooth Shoulderpads", "=ds=#m29#" },
		{ 34194, "INV_Shoulder_90", "=q4=Mantle of the Golden Forest", "=ds=#s3#, #a3#" },
		{ 34208, "INV_Shoulder_90", "=q4=Equilibrium Epaulets", "=ds=#s3#, #a3#" },
		{ 34390, "INV_Shoulder_90", "=q4=Erupting Epaulets", "=ds=#m29#" },
		{ 34192, "INV_Shoulder_22", "=q4=Pauldrons of Perseverance", "=ds=#s3#, #a4#" },
		{ 34388, "INV_Shoulder_11", "=q4=Pauldrons of Berserking", "=ds=#m29#" },
        { 0,"","","" },
        { 0,"","","" },
		{ 35290, "INV_Jewelry_Necklace_36", "=q4=Sin'dorei Pendant of Conquest", "=ds=#s2#" },
		{ 35291, "INV_Jewelry_Necklace_36", "=q4=Sin'dorei Pendant of Salvation", "=ds=#s2#" },
		{ 35292, "INV_Jewelry_Necklace_36", "=q4=Sin'dorei Pendant of Triumph", "=ds=#s2#" },
		{ 34204, "INV_Jewelry_Necklace_40", "=q4=Amulet of Unfettered Magics", "=ds=#s2#" },
        { 34189, "INV_Jewelry_Ring_36", "=q4=Band of Ruinous Delight", "=ds=#s13#" },
        { 34206, "INV_Offhand_Sunwell_D_01", "=q4=Book of Highborne Hymns", "=ds=#s15#" },
        { 34197, "INV_Weapon_Shortblade_75", "=q4=Shiv of Exsanguination", "=ds=#h1#, #w4#" },
        { 34199, "INV_Mace_71", "=q4=Archon's Gavel", "=ds=#h3#, #w6#" },
		{ 34203, "INV_Weapon_Hand_15", "=q4=Grip of Mannoroth", "=ds=#h4#, #w13#" },
        { 34198, "INV_Staff_12", "=q4=Stanchion of Primal Instinct", "=ds=#w9#" },
        { 34196, "INV_Weapon_Bow_38", "=q4=Golden Bow of Quel'Thalas", "=ds=#w3#" },
	};
    ...
    SPKiljaeden = {
        { 34439, "INV_Helmet_53", "=q4=Cowl of Light's Purity", "=ds=#s1#, #a1#" },
		{ 34405, "INV_Helmet_32", "=q4=Helm of Arcane Purity", "=ds=#m29#" },
        { 34342, "INV_Gauntlets_16", "=q4=Handguards of the Dawn", "=ds=#s9#, #a1#" },
		{ 34406, "INV_Gauntlets_16", "=q4=Gloves of Tyri's Power", "=ds=#m29#" },
        { 34244, "INV_Helmet_126", "=q4=Duplicitous Guise", "=ds=#s1#, #a2#" },
		{ 34404, "INV_Helmet_126", "=q4=Mask of the Furry Hunter", "=ds=#m29#" },
        { 34245, "INV_Helmet_126", "=q4=Cover of Ursol the Wise", "=ds=#s1#, #a2#" },
		{ 34403, "INV_Helmet_126", "=q4=Cover of Ursoc the Mighty", "=ds=#m29#" },
        { 34332, "INV_Helmet128", "=q4=Cowl of Gul'dan", "=ds=#s1#, #a3#" },
		{ 34402, "INV_Helmet128", "=q4=Shroud of Chieftain Ner'zhul", "=ds=#m29#" },
        { 34243, "INV_Helmet_25", "=q4=Helm of Burning Righteousness", "=ds=#s1#, #a4#" },
		{ 34401, "INV_Helmet_25", "=q4=Helm of Uther's Resolve", "=ds=#m29#" },
        { 34345, "INV_Helmet_92", "=q4=Crown of Anasterian", "=ds=#s1#, #a4#" },
		{ 34400, "INV_Helmet_08", "=q4=Crown of Dath'Remar", "=ds=#m29#" },
		{ 0,"","","" },
        { 0, "?", "=q5=Thori'dal, the Stars' Fury", "=ds=#w2#" },
		{ 0,"","","" },
        { 0, "?", "=q4=Apolyon, the Soul-render", "=ds=#h2#, #w10#" },
	};

    SPTrash = {
        { 34233, "INV_Chest_Cloth_32", "=q4=Robes of Faltered Light", "=ds=#s5#, #a1#" },
        { 34351, "INV_Gauntlets_48", "=q4=Tranquil Majesty Wraps", "=ds=#s9#, #a2#" },
        { 34407, "INV_Gauntlets_51", "=q4=Tranquil Moonlight Wraps", "=ds=#m29#" },
	    { 34352, "INV_Gauntlets_68", "=q4=Borderland Fortress Grips", "=ds=#s9#, #a4#" },
        { 34350, "INV_Gauntlets_41", "=q4=Gauntlets of the Ancient Shadowmoon", "=ds=#s9#, #a3#" },
		{ 34409, "INV_Gauntlets_52", "=q4=Gauntlets of the Ancient Frostwolf", "=ds=#m29#" },
        { 35733, "INV_Jewelry_Ring_57", "=q4=Ring of Harmonic Beauty", "=ds=#s13#" },
        { 34183, "INV_Weapon_Halberd_20", "=q4=Shivering Felspine", "=ds=#h2#, #w7#" },
        { 34346, "INV_Weapon_Hand_13", "=q4=Mounting Vengeance", "=ds=#h4#, #w13#" },
        { 34349, "INV_ThrowingKnife_07", "=q4=Blade of Life's Inevitability", "=ds=#w11#" },
        { 34348, "INV_Wand_24", "=q4=Wand of Cleansing Light", "=ds=#w12#" },
        { 34347, "INV_Wand_25", "=q4=Wand of the Demonsoul", "=ds=#w12#" },
        { 0,"","","" },
        { 34664, "Spell_Nature_ElementalShields", "=q3=Sunmote", "=ds=#s12#, #a4#" },
        { 0,"","","" },
        { 32228, "INV_Jewelcrafting_EmpyreanSapphire_01", "=q4=Empyrean Sapphire", "=ds=#e7#" },
        { 32231, "INV_Jewelcrafting_Pyrestone_01", "=q4=Pyrestone", "=ds=#e7#" },
        { 32229, "INV_Jewelcrafting_Lionseye_01", "=q4=Lionseye", "=ds=#e7#" },
        ...
        { 32230, "INV_Jewelcrafting_ShadowsongAmethyst_01", "=q4=Shadowsong Amethyst", "=ds=#e7#" },
        { 32227, "INV_Jewelcrafting_CrimsonSpinel_01", "=q4=Crimson Spinel", "=ds=#e7#" },
        { 35207, "INV_Scroll_04", "=q4=Pattern: Robe of Eternal Light", "=ds=#p8# (365)" },
        { 35189, "INV_Scroll_04", "=q4=Schematic: Powerheal 9000 Lens", "=ds=#p5# (375)" },
        { 35190, "INV_Scroll_04", "=q4=Schematic: Hyper Magnified Moon-Specs", "=ds=#p5# (375)" },
        { 35205, "INV_Scroll_04", "=q4=Pattern: Hands of Eternal Light", "=ds=#p8# (365)" },
        { 35199, "INV_Scroll_04", "=q4=Design: Ring of Flowing Life", "=ds=#p12# (365)" },
        { 0,"","","" },
        { 35273, "INV_Misc_Book_08", "=q1=Study of Advanced Smelting", "=ds=#p23# (375)" },
	};

    SunwellIsleNoDropLocationTrinkets = {
        { 0, "?", "=q4=Glimmering Naaru Silver", "=ds=#s14#" },
        { 0, "?", "=q4=Steely Naaru Silver", "=ds=#s14#" },
        { 0, "?", "=q4=Blackened Naaru Silver", "=ds=#s14#" },
	};

    SunwellIsleNoDropLocationShields = {
        { 0, "?", "=q4=Aegis of Angelic Fortune", "=ds=#w8#" },
	};

    SunwellIsleNoDropLocationMelee = {
        { 0, "?", "=q4=Muramasa", "=ds=#h1#, #w10#" },
        { 0, "?", "=q4=Crux of the Acopalypse", "=ds=#h1#, #w4#" },
	};

    SunwellIsleNoDropLocationMelee = {
        { 0, "?", "=q4=Golden Staff of the Sin'dorei", "=ds=#w9#" },
        { 0, "?", "=q4=Sunflare", "=ds=#h3#, #w4#" },
	};
};
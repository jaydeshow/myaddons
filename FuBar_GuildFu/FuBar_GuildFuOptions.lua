	...
	type = "group", args = {
		["text"] = {
			type = "group", name = L["Text"], desc = L["Text Settings"], args = {
				["show_guildname"] = {
					type = "toggle", name = L["Show Guild Name"], desc = L["Toggles display of the guild name"],
					get = function() return FuBar_GuildFu.db.profile.text.show_guildname end,
					set = function(v) FuBar_GuildFu.db.profile.text.show_guildname = v; FuBar_GuildFu:UpdateText() end,
					order = 1,
				},
				["show_displayed"] = {
			...
			type = "group", name = L["Filter"], desc = L["Filter Settings"], args = {
				...
				["level"] = {
					type = "group", name = L["Level"], desc = L["Level Filter Settings"], args = {
						...
						["6069"] = {
							type = "toggle", name = L["60-69"], desc = L["Toggles display of level 60 to 69 chars"],
							get = function() return FuBar_GuildFu.db.profile.filter.level_6069 end,
							set = function(v) FuBar_GuildFu.db.profile.filter.level_6069 = v; FuBar_GuildFu:Update() end,
							order = 7,
						},
						["70"] = {
							type = "toggle", name = L["70"], desc = L["Toggles display of level 70 chars"],
							get = function() return FuBar_GuildFu.db.profile.filter.level_70 end,
							set = function(v) FuBar_GuildFu.db.profile.filter.level_70 = v; FuBar_GuildFu:Update() end,
							order = 8,
						},
					}, order = 2,
				},

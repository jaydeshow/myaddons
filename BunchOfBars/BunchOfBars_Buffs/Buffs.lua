...
L:RegisterTranslations("zhCN", function() return {
	[moduleName] = "Buff-增益效果",

	["Always"] = "一直显示",
	["Enable/Disable buffs which are always shown."] = "选择/不选择 哪些增益效果需要一直显示的",

	["Out Of Combat"] = "非战斗时显示",
	["Enable/Disable Out of combat buffs."] = "选择/不选择 哪些增益效果只在非战斗状态时显示",

	["Text Color"] = "文字颜色",
	["Change the text color."] = "变更文字颜色",

	["Enable/Disable showing of "] = "选择/不选择 显示 "
}end)
--#end
...
plugin.revision = tonumber(("$Revision: 53931 $"):match("%d+"))

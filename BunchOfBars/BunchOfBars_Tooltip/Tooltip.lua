...
L:RegisterTranslations("zhCN", function() return {
	...
	["Show Tooltip"] = "显示提示信息",
	["When to show the unit's tooltip."] = "什么时候相关的显示提示信息",
...
local tooltiprev = { } -- reverse lookup of tooltip table
do
...
function plugin:GetSetToolTip(value)
	if type(value) == "nil" then return tooltip[self.db.profile.showtooltip] end

	self.db.profile.showtooltip = tooltiprev[value]
end

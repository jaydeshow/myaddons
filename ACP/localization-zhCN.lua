...
if (GetLocale() == 	"zhCN") then
	...
	["Remove from current selection"] = "移除当前选择";
		["Rename"] = "重命名";
		["Use SHIFT to override the current enabling of dependancies behaviour."] = "使用Shift键无视目前的递归设定。",
		["Press CTRL to override the enabling of LoD children."] = "使用Ctrl键无视目前的按需求加载子插件设定。",

...
elseif GAME_LOCALE == "zhCN" then
	...
	-- Subzones used for displaying instances.
		...
		["Azjol-Nerub"] = "艾卓-尼鲁布",
		["Chamber of Aspects"] = "Chamber of Aspects",--what is ??
		["Drak'Tharon Keep"] = "达克萨隆要塞",
		["Gundrak"] = "古达克",
		["Halls of Stone"] = "岩石大厅",
		["Halls of Lightning"] = "闪电大厅",
		["The Eye of Eternity"] = "永恒之眼",--check
		["The Nexus"] = "魔枢",
		["The Oculus"] = "奧核之眼",--check
		["The Violet Hold"] = "紫罗兰堡",--check
		["Ulduar"] = "奥杜尔", --Site seem uncertain on the name
		["Utgarde Keep"] = "乌特加德城堡",
		["Utgarde Pinnacle"] = "乌特加德之巅",
		["Stratholme Past"] = "往日的斯坦索姆",
}
...
elseif GAME_LOCALE == "zhTW" then
	lib:SetCurrentTranslations {
		...
		["Champions' Hall"] = "勇士大廳",
		["Hall of Champions"] = "勇士大廳",--WMOAreaTableDBC
	...
	-- Subzones used for displaying instances.
		...
		["Ulduar"] = "奧杜亞", --Site seem uncertain on the name
		["Utgarde Keep"] = "俄特加德要塞",
		["Utgarde Pinnacle"] = "俄特加德之巔",
		["Stratholme Past"] = "過往的斯坦索姆",
}

...
L:RegisterTranslations("zhTW", function() return {
	...
	["Roll ending in 5 seconds, recorded %d of %d rolls."] = "擲骰 5 秒內結束，記錄了 %d/%d 組擲骰者",

	["Winner: %s."] = "優勝: %s",
	[", "] = "，",
	["Tie: %s are tied at %d."] = "同分: %s 都 %d 點",
	["%s (%d/%d)"] = "%s (%d/%d)",
	["%s [%s]"] = "%s [%s]",
	["%d of expected %d rolls recorded."] = "已記錄 %d/%d 位擲骰者",

	["Perform roll when clicked"] = "左擊擲骰",
	["Perform a standard 1-100 roll when the FuBar plugin is clicked."] = "左擊時使用標準擲骰 (1-100)",
	["Announce"] = "發表擲骰結果",
	["Only accept 1-100"] = "只接受 1-100",
	...
	["Reset all available instance the group leader has active."] = "重置所有隊長所開啟的副本",
} end)

...
function addon:InitBlackSmith()
	...
	self:addTradeSkillSpell(21161, 300, L["Sulfuron Hammer Obt"], 6)
	...
	-- Raid Drops
	self:addTradeSkillSpell(22757, 300, L["MOLTENCORE"], 6)
	self:addTradeSkillSpell(27589, 300, L["Black Grasp of the Destroyer Obt"], 6)
	self:addTradeSkillSpell(27587, 300, L["Thick Obsidian Breastplate Obt"], 6)
	self:addTradeSkillSpell(36392, 375, L["SSC/TKBoE"], 6)
	self:addTradeSkillSpell(36389, 375, L["SSC/TKBoP"], 6)
	self:addTradeSkillSpell(36390, 375, L["SSC/TKBoP"], 6)
	self:addTradeSkillSpell(36391, 375, L["SSC/TKBoE"], 6)
	self:addTradeSkillSpell(41134, 375, L["BT/HYJALBoP"], 6)
	self:addTradeSkillSpell(41135, 375, L["BT/HYJALBoE"], 6)
	self:addTradeSkillSpell(41132, 375, L["BT/HYJALBoP"], 6)
	self:addTradeSkillSpell(41133, 375, L["BT/HYJALBoE"], 6)

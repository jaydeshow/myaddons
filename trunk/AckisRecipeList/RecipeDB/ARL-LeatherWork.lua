...
function addon:InitLeatherWorking()
	...
	-- Specific Drops
	self:addTradeSkillSpell(5244, 40, self:CombineQuests(L["Kodo Hide Bag Obt"],2,BZONE["The Barrens"]), {BFAC["Horde"]})
	...
	self:addTradeSkillSpell(24124, 300, self:AddSingleReputation(3, BFAC["Zandalar Tribe"]), {BFAC["Zandalar Tribe"], L["Raid"]})
	self:addTradeSkillSpell(24125, 300, self:AddSingleReputation(2, BFAC["Zandalar Tribe"]), {BFAC["Zandalar Tribe"], L["Raid"]})
	self:addTradeSkillSpell(24123, 300, self:AddSingleReputation(1, BFAC["Zandalar Tribe"]), {BFAC["Zandalar Tribe"], L["Raid"]})
	self:addTradeSkillSpell(24122, 300, self:AddSingleReputation(2, BFAC["Zandalar Tribe"]), {BFAC["Zandalar Tribe"], L["Raid"]})
	self:addTradeSkillSpell(24121, 300, self:AddSingleReputation(3, BFAC["Zandalar Tribe"]), {BFAC["Zandalar Tribe"], L["Raid"]})
	...
	self:addTradeSkillSpell(28224, 300, self:AddSingleReputation(3, BFAC["Argent Dawn"]) .. addon.br .. L["ADNaxx"], {BFAC["Argent Dawn"], L["Raid"]})
	self:addTradeSkillSpell(28222, 300, self:AddSingleReputation(4, BFAC["Argent Dawn"]) .. addon.br .. L["ADNaxx"], {BFAC["Argent Dawn"], L["Raid"]})
	self:addTradeSkillSpell(28223, 300, self:AddSingleReputation(3, BFAC["Argent Dawn"]) .. addon.br .. L["ADNaxx"], {BFAC["Argent Dawn"], L["Raid"]})
	self:addTradeSkillSpell(28221, 300, self:AddSingleReputation(3, BFAC["Argent Dawn"]) .. addon.br .. L["ADNaxx"], {BFAC["Argent Dawn"], L["Raid"]})
	self:addTradeSkillSpell(28220, 300, self:AddSingleReputation(3, BFAC["Argent Dawn"]) .. addon.br .. L["ADNaxx"], {BFAC["Argent Dawn"], L["Raid"]})
	self:addTradeSkillSpell(28219, 300, self:AddSingleReputation(4, BFAC["Argent Dawn"]) .. addon.br .. L["ADNaxx"], {BFAC["Argent Dawn"], L["Raid"]})
	...
	self:addTradeSkillSpell(39997, 375, self:AddSingleReputation(1, BFAC["Ashtongue Deathsworn"]), {L["Raid"], BFAC["Ashtongue Deathsworn"]})
	self:addTradeSkillSpell(40000, 375, self:AddSingleReputation(1, BFAC["Ashtongue Deathsworn"]), {L["Raid"], BFAC["Ashtongue Deathsworn"]})
	self:addTradeSkillSpell(40002, 375, self:AddSingleReputation(2, BFAC["Ashtongue Deathsworn"]), {L["Raid"], BFAC["Ashtongue Deathsworn"]})
	self:addTradeSkillSpell(40001, 375, self:AddSingleReputation(2, BFAC["Ashtongue Deathsworn"]), {L["Raid"], BFAC["Ashtongue Deathsworn"]})
	self:addTradeSkillSpell(42546, 350, self:AddSingleReputation(4, BFAC["The Violet Eye"]), {L["Raid"], BFAC["The Violet Eye"]})
	self:addTradeSkillSpell(40006, 375, self:AddSingleReputation(1, BFAC["Ashtongue Deathsworn"]), {L["Raid"], BFAC["Ashtongue Deathsworn"]})
	self:addTradeSkillSpell(40005, 375, self:AddSingleReputation(1, BFAC["Ashtongue Deathsworn"]), {L["Raid"], BFAC["Ashtongue Deathsworn"]})
	self:addTradeSkillSpell(40003, 375, self:AddSingleReputation(2, BFAC["Ashtongue Deathsworn"]), {L["Raid"], BFAC["Ashtongue Deathsworn"]})
	self:addTradeSkillSpell(40004, 375, self:AddSingleReputation(2, BFAC["Ashtongue Deathsworn"]), {L["Raid"], BFAC["Ashtongue Deathsworn"]})
	self:addTradeSkillSpell(42731, 355, self:AddSingleReputation(3, BFAC["The Violet Eye"]), {L["Raid"], BFAC["The Violet Eye"]})

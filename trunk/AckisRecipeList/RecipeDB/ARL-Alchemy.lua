...
$Date: 2008-06-03 17:44:01 -0400 (Tue, 03 Jun 2008) $
$Rev: 75937 $
...
function addon:InitAlchemy()
	...
	self:addTradeSkillSpell(17553, 260, L["Trainer"] .. addon.br .. self:CombineVendors(134, false), 1, 2)
	...
	self:addTradeSkillSpell(39639, 330, self:CombineVendors(162, 163, false), L["PVP"],2)
	...
	self:addTradeSkillSpell(3451, 180, L["CWD"] .. addon.br .. L["Mighty Trolls Blood Potion Obt"] .. BZONE["Razorfen Downs"],3)
	...
	self:addTradeSkillSpell(17580, 295, self:CombineMobs(true,BBOSS["Darkmaster Gandling"],BZONE["Scholomance"]) .. addon.br .. L["Spectral Essence Obt"],4,5,8)
	self:addTradeSkillSpell(17635, 300, self:CombineMobs(false,BBOSS["General Drakkisath"],BZONE["Upper Blackrock Spire"]) .. addon.br .. self:AddSingleReputation(4, BFAC["The Sha'tar"]), BFAC["The Sha'tar"],3,5)
	self:addTradeSkillSpell(17636, 300, self:CombineMobs(false,BBOSS["Balnazzar"],BZONE["Stratholme"]) .. addon.br .. self:AddSingleReputation(4, BFAC["Cenarion Expedition"]), BFAC["Cenarion Expedition"],3,5)
	self:addTradeSkillSpell(17637, 300, self:CombineMobs(false,BBOSS["Ras Frostwhisper"],BZONE["Scholomance"]) .. addon.br .. self:AddSingleReputation(4, BFAC["Keepers of Time"]), BFAC["Keepers of Time"],3,5)
	self:addTradeSkillSpell(17638, 300, self:CombineMobs(false,BBOSS["Gyth"],BZONE["Upper Blackrock Spire"]) .. addon.br .. self:AddSingleReputation(4, BFAC["Lower City"]), BFAC["Lower City"],3,5)
	...
	self:addTradeSkillSpell(28579, 365, self:CombineMobs(true,BBOSS["Captain Skarloc"],BZONE["Old Hillsbrad Foothills"]),5)

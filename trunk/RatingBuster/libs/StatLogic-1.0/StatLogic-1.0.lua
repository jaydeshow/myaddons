...
Revision: $Revision: 65752 $
Author: Whitetooth
Email: hotdogee [at] gmail [dot] com
LastUpdate: $Date: 2008-03-25 11:37:14 -0400 (Tue, 25 Mar 2008) $
Website:
Documentation:
SVN: $URL: svn://dev.wowace.com/wowace/trunk/StatLogicLib/StatLogic-1.0/StatLogic-1.0.lua $
Dependencies: AceLibrary, AceLocale-2.2, Babble-Spell-2.2, UTF8
License: LGPL v2.1
Features:
	StatConversion -
		Ratings -> Effect
...
local MINOR_VERSION = tonumber(("$Revision: 65752 $"):sub(12, -3))
...
---------------
local BS
if LibStub and LibStub:GetLibrary("LibBabble-Spell-3.0", true) then
	BS = LibStub("LibBabble-Spell-3.0"):GetLookupTable()
else
...
PatternLocale.zhCN = {
	...
	-- stat = stat1..stat2
	-- "^Equip: (.-) by u?p? ?t?o? ?(%d+) ?(.-)%.$"
	["SingleEquipStatCheck"] = "装备：(.-)提高最多(%d+)点(.-)。$",
	--"装备: (.-)提高(最多)?(%d+)(点)?(.-)。$",
	-------------
	-- PreScan --
	-------------

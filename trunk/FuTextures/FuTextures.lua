...
FuBar:RegisterSkin("Sairen","Interface\\Addons\\FuTextures\\sairen") -- Sairen
FuBar:RegisterSkin("Bouvi","Interface\\Addons\\FuTextures\\bouvi") -- John Doe
FuBar:RegisterSkin("Deep Cave","Interface\\Addons\\FuTextures\\deepcave") -- Teshnor
FuBar:RegisterSkin("Fin","Interface\\Addons\\FuTextures\\fin") -- Fin (based on Sairen's)

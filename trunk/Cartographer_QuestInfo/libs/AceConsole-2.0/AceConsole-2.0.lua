...
if GetLocale() == "zhCN" then
	...
	USAGE = "用法"
	IS_CURRENTLY_SET_TO = "|cffffff7f%s|r目前被设置为|cffffff7f[|r%s|cffffff7f]|r"
	IS_NOW_SET_TO = "|cffffff7f%s|r现在被设置为|cffffff7f[|r%s|cffffff7f]|r"
	IS_NOT_A_VALID_OPTION_FOR = "对于|cffffff7f%s|r，[|cffffff7f%s|r]是一个不符合规定的选项"
	IS_NOT_A_VALID_VALUE_FOR = "对于|cffffff7f%s|r，[|cffffff7f%s|r]是一个不符合规定的数值"
	NO_OPTIONS_AVAILABLE = "没有可用的选项"
	OPTION_HANDLER_NOT_FOUND = "没有找到选项处理程序|cffffff7f%q|r。"
	OPTION_HANDLER_NOT_VALID = "选项处理程序无效。"
	OPTION_IS_DISABLED = "选项|cffffff7f%s|r已被禁用。"
	KEYBINDING_USAGE = "<ALT-CTRL-SHIFT 键>"
	DEFAULT_CONFIRM_MESSAGE = "你是否确定要执行“%s”？"

...
-- Core.lua
	...
	["Exporting %d quests..."] = "已匯出 %d 個任務...",
	["Total %d quests have been exported."] = "總計匯出 %d 個任務起始點。",
	["Clear old exported quests first."] = "首先清除舊的任務起始點。",
	["Begin exporting new quests."] = "開始匯出新的任務起始點。",

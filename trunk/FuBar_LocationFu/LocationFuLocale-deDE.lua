...
L:AddTranslations("deDE", function() return {
	...
	["Show the bar above the minimap that tells the location and allows you to close minimap"] = "Zeige die Titelleiste mit der Gebietsanzeige der Minikarte, mit der die Minikarte ein- und ausgeschaltet werden kann",

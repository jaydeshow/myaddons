...
Process("MidsummerFestival",19,{"","","","","=q2=煤渣護腕","","=q3=捕捉到的烈焰","=q1=燃燒之花","=q1=節慶烈酒","=q1=紫梅派","=q1=火烤麵包","=q1=仲夏香腸","=q1=燒烤史馬克","","","=q1=火焰節慶之冠","=q1=火焰節慶披肩"}) --Missing: 34683, 34684, 34685, 34686, 35279, 35280

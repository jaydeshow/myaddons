...
if (GetLocale() == "ruRU") then
	AutoBar.locale = {
		...
		["Assign Bindings for Buttons on your Bars."] = "Назначить переплетах кнопки на вашем барах.",
		["Scale"] = "Scale",
		...
		["Drag a Button to move it, right click to configure the Button."] = "Перетащите кнопку, чтобы переместить его, щелкните правой кнопкой мыши для настройки кнопок.",

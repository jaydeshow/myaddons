...
--[[
	AutoBar:Print(tostring(event) .. " GetZoneText()" .. GetZoneText())
	AutoBar:Print(tostring(event) .. " GetRealZoneText()" .. GetRealZoneText())
	AutoBar:Print(tostring(event) .. " GetSubZoneText()" .. GetSubZoneText())
	AutoBar:Print(tostring(event) .. " GetMinimapZoneText()" .. GetMinimapZoneText())
	AutoBar:Print(tostring(event) .. " GetMinimapZoneText()" .. GetMinimapZoneText())
--]]
	...
	if (not newZone) then
		...
		if (zone and zone ~= "") then
			newZone = AutoBarSearch.subZoneGroup[GetSubZoneText()]
		end
	end
...
--			BF:CloseMenu()
		...
		self:Print(L["ButtonFacade is required to Skin the Buttons"])
	end
end

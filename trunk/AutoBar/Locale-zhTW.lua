...
L:RegisterTranslations("zhTW", function() return {
	...
	["Show Hotkey Text for %s"] = "在按鈕上顯示%s的快捷鍵",
	["Show Grid"] = "顯示格子",
	["Show the grid of the bar even while locked."] = "在物品列鎖定時仍然顯示物品列格子。",
		["Alpha"] = "透明度",
		...
		["Enable %s."] = "啟用%s。",
		["No Popup"] = "不彈出按鈕";
		["No Popup for %s"] = "不彈出%s按鈕";
		["Show Count Text"] = "顯示物品數量";
		["Show Count Text for %s"] = "顯示%s的物品數量";
		["Show Empty Buttons"] = "顯示空按鈕";
		["Show Empty Buttons for %s"] = "顯示%s空按鈕";
		["Number of columns for %s"] = "%s的欄位數目",
		["FadeOut"] = "淡出",
		["Fade out the Bar when not hovering over it."] = "當滑鼠移開時淡化物品列。",
		["Frame Level"] = "框架層級",
		...
		["Order"] = "順序",
		["Change the order of %s in the Bar"] = "改變%s在物品列的順序",
		["Padding"] = "間距",
		...
		["Sticky Frames"] = "粘性框架",
		["Style"] = "樣式",
		["Change the style of the bar."] = "改變物品列的樣式。",
		["Targeted"] = "目標",
		...
		["Self Casting"] = "自我施法",
		["Configure Self Casting options"] = "設定自我施法選項",
		...
		["AutoBarButtonTrinket1"] = "飾品1",
		["AutoBarButtonTrinket2"] = "飾品2",
		...
		["Consumable.Food.Combo Health"] = "食物: 生命力及法力";
		...
		["Consumable.Buff Type.Both"] = "增益: 作戰及防護藥劑";

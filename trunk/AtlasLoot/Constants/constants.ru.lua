...
AL:RegisterTranslations("ruRU", function() return {
    ...
    ["Req. Rating:"] = "Треб. Рейтинг",  --Shorthand for 'Required Rating' for the personal/team ratings in Arena S4

    --Text for Options Panel
    ["Atlasloot Options"] = "Опции Atlasloot",
    ["Safe Chat Links |cff1eff00(recommended)|r"] = "Безопасные ссылки |cff1eff00(рекомендуется)|r",
    ["Enable all Chat Links |cffff0000(use at own risk)|r"] = "Включить все ссылки чата |cffff0000(пользуйтесь на свой риск)|r",
    ...
    ["Make Loot Table Opaque"] = "Непрозрачное окно лута",
    ...
    ["Notify me when a LoD Module is loaded"] = "Выводить сообщение об авто-загрузке доп. модулей",
    ["Load all loot modules at startup"] = "Загружать все модули при старте",
    ["AutoQuery items on loot tables |cffff0000(disconnection risk)|r"] = "Авто-запрос инф. опасных предметов |cffff0000(риск отсоединения)|r",
    ["Done"] = "Готово",
    ["WishList"] = "Пожелания",
    ...
    ["Use to purchase rewards"] = "Используется для покупки наград",
    ["Use to purchase rewards (Horde)"] = "Используется для покупки наград (Орда)",
    ["Use to purchase rewards (Alliance)"] = "Используется для покупки наград (Альянс)",
    ["World Bosses"] = "Мировые боссы",
    ["Reputation Factions"] = "Репутация у фракций",
    ["Sets/Collections"] = "Наборы/Коллекции",
    ...
    ["Superior Rewards"] = "Супер награды",
    ...
    --Set Labels
    ["Set: Embrace of the Viper"] = "Набор: Embrace of the Viper",
    ["Set: Defias Leather"] = "Набор: Defias Leather",
    ["Set: The Gladiator"] = "Набор: The Gladiator",
    ["Set: Chain of the Scarlet Crusade"] = "Набор: Chain of the Scarlet Crusade",
    ["Set: The Postmaster"] = "Набор: The Postmaster",
    ["Set: Necropile Raiment"] = "Набор: Necropile Raiment",
    ["Set: Cadaverous Garb"] = "Набор: Cadaverous Garb",
    ["Set: Bloodmail Regalia"] = "Набор: Bloodmail Regalia",
    ["Set: Deathbone Guardian"] = "Набор: Deathbone Guardian",
    ["Set: Dal'Rend's Arms"] = "Набор: Dal'Rend's Arms",
    ["Set: Spider's Kiss"] = "Набор: Spider's Kiss",
    ["Temple of Ahn'Qiraj Sets"] = "Набор из Храма Ан'Киража",
    ["AQ40 Class Sets"] = "Классовые наборы АК40",
    ["Ruins of Ahn'Qiraj Sets"] = "Набор из Руин Ан'Киража",
    ["AQ20 Class Sets"] = "Классовые наборы АК20",
    ["AQ Enchants"] = "Зачарования из АК",
    ["AQ Opening Quest Chain"] = "AQ Opening Quest Chain",
    ["Pre 60 Sets"] = "Наборы до 60 уровня",
    ["Crafted Sets"] = "Изготов-ные наборы",
    ["Crafted Epic Weapons"] = "Изготов-ные Эпические Оружия",
    ["Zul'Gurub Sets"] = "Наборы Зул'Гуруба",
    ["ZG Class Sets"] = "Классовые наборы ЗГ",
    ["ZG Enchants"] = "Зачарования из ЗГ",
    ["Dungeon 1/2 Sets"] = "Наборы подземелий 1/2",
    ["Dungeon 1 Set"] = "Наборы подземелий 1",
    ["Dungeon 2 Set"] = "Наборы подземелий 2",
    ["Dungeon 3 Sets"] = "Наборы подземелий 3",
    ["Tier 1 Sets"] = "Набор 1 Тира",
    ["Tier 2 Sets"] = "Набор 2 Тира",
    ["Tier 3 Sets"] = "Набор 3 Тира",
    ["Tier 4 Sets"] = "Набор 4 Тира",
    ["Tier 5 Sets"] = "Набор 5 Тира",
    ["Tier 6 Sets"] = "Набор 6 Тира",
    ["PvP Sets (Level 60)"] = "PvP Наборы (Уровень 60)",
    ["PvP Sets (Level 70)"] = "PvP Наборы (Уровень 70)",
    ["PvP Reputation Sets (Level 70)"] = "Наборы PvP за репутацию (Уровень 70)",
    ...
    ["PvP Armor Sets"] = "PvP Наборы Доспехов",
    ...
    ["PvP Non-Set Epics"] = "PvP Вне-сетовые Эпики",
    ["PvP Honor System"] = "PvP Системы Чести",
    ["PvP Reputation Sets"] = "PvP Наборы",
    ["Arena PvP Sets"] = "Арена PvP Наборы",
    ["Arena 2 PvP Sets"] = "Арена 2 PvP Наборы",
    ["Arena 3 PvP Sets"] = "Арена 3 PvP Наборы",
    ["Arena 4 PvP Sets"] = "Арена 4 PvP Наборы",
    ...
    ["Class Set Pieces"] = "Куски классовых наборов",
    ["Epic Set"] = "Эпические наборы",
    ["Rare Set"] = "Редкие наборы",
    ["Legendary Items"] = "Легендарные предметы",
    ["Lvl 70 Instance Token Rewards"] = "Lvl 70 Instance Token Rewards",
    ["Lvl 70 Instance Rewards"] = "Lvl 70 Instance Rewards",

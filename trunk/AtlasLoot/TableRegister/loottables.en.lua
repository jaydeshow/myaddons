...
-----------------
  ...
  --The Deadmines
    ...
    AtlasLoot_TableNames["VCForemanThistlenettle"] = { BabbleBoss["Foreman Thistlenettle"], "AtlasLootItems" };
    AtlasLoot_TableNames["VCRhahkZor"] = { BabbleBoss["Rhahk'Zor"], "AtlasLootItems" };
    AtlasLoot_TableNames["VCMinerJohnson"] = { BabbleBoss["Miner Johnson"].." ("..AL["Rare"]..")", "AtlasLootItems" };
    AtlasLoot_TableNames["VCSneed"] = { BabbleBoss["Sneed"], "AtlasLootItems" };
    AtlasLoot_TableNames["VCSneedsShredder"] = { BabbleBoss["Sneed's Shredder"], "AtlasLootItems" };
    AtlasLoot_TableNames["VCGilnid"] = { BabbleBoss["Gilnid"], "AtlasLootItems" };
    AtlasLoot_TableNames["VCCaptainGreenskin"] = { BabbleBoss["Captain Greenskin"], "AtlasLootItems" };
    AtlasLoot_TableNames["VCVanCleef"] = { BabbleBoss["Edwin VanCleef"], "AtlasLootItems" };
    AtlasLoot_TableNames["VCMrSmite"] = { BabbleBoss["Mr. Smite"], "AtlasLootItems" };
    AtlasLoot_TableNames["VCCookie"] = { BabbleBoss["Cookie"], "AtlasLootItems" };
...
------------
  ...
  --AQ20 Sets
    AtlasLoot_TableNames["AQ20Druid"] = { BabbleClass["Druid"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ20Hunter"] = { BabbleClass["Hunter"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ20Mage"] = { BabbleClass["Mage"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ20Paladin"] = { BabbleClass["Paladin"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ20Priest"] = { BabbleClass["Priest"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ20Rogue"] = { BabbleClass["Rogue"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ20Shaman"] = { BabbleClass["Shaman"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ20Warlock"] = { BabbleClass["Warlock"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ20Warrior"] = { BabbleClass["Warrior"].." - "..AL["AQ20 Class Sets"], "AtlasLootSetItems" };
  --AQ40 Sets
    AtlasLoot_TableNames["AQ40Druid"] = { BabbleClass["Druid"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ40Hunter"] = { BabbleClass["Hunter"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ40Mage"] = { BabbleClass["Mage"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ40Paladin"] = { BabbleClass["Paladin"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ40Priest"] = { BabbleClass["Priest"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ40Rogue"] = { BabbleClass["Rogue"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ40Shaman"] = { BabbleClass["Shaman"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ40Warlock"] = { BabbleClass["Warlock"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["AQ40Warrior"] = { BabbleClass["Warrior"].." - "..AL["AQ40 Class Sets"], "AtlasLootSetItems" };
  --Dungeon Set 1/2
  ...
  --Dungeon Set 3
    AtlasLoot_TableNames["DS3Hallowed"] = { AL["Hallowed Raiment"].." - "..BabbleInventory["Cloth"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Incanter"] = { AL["Incanter's Regalia"].." - "..BabbleInventory["Cloth"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Mana"] = { AL["Mana-Etched Regalia"].." - "..BabbleInventory["Cloth"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Oblivion"] = { AL["Oblivion Raiment"].." - "..BabbleInventory["Cloth"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Assassin"] = { AL["Assassination Armor"].." - "..BabbleInventory["Leather"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Moonglade"] = { AL["Moonglade Raiment"].." - "..BabbleInventory["Leather"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Wastewalker"] = { AL["Wastewalker Armor"].." - "..BabbleInventory["Leather"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Beast"] = { AL["Beast Lord Armor"].." - "..BabbleInventory["Mail"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Desolation"] = { AL["Desolation Battlegear"].." - "..BabbleInventory["Mail"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Tidefury"] = { AL["Tidefury Raiment"].." - "..BabbleInventory["Mail"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Bold"] = { AL["Bold Armor"].." - "..BabbleInventory["Plate"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Doom"] = { AL["Doomplate Battlegear"].." - "..BabbleInventory["Plate"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["DS3Right"] = { AL["Righteous Armor"].." - "..BabbleInventory["Plate"], "AtlasLootSetItems" };
  --T1 Sets
    AtlasLoot_TableNames["T1Druid"] = { BabbleClass["Druid"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T1Hunter"] = { BabbleClass["Hunter"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T1Mage"] = { BabbleClass["Mage"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T1Paladin"] = { BabbleClass["Paladin"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T1Priest"] = { BabbleClass["Priest"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T1Rogue"] = { BabbleClass["Rogue"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T1Shaman"] = { BabbleClass["Shaman"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T1Warlock"] = { BabbleClass["Warlock"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T1Warrior"] = { BabbleClass["Warrior"].." - "..AL["Tier 1 Sets"], "AtlasLootSetItems" };
  --T2 Sets
    AtlasLoot_TableNames["T2Druid"] = { BabbleClass["Druid"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T2Hunter"] = { BabbleClass["Hunter"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T2Mage"] = { BabbleClass["Mage"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T2Paladin"] = { BabbleClass["Paladin"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T2Priest"] = { BabbleClass["Priest"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T2Rogue"] = { BabbleClass["Rogue"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T2Shaman"] = { BabbleClass["Shaman"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T2Warlock"] = { BabbleClass["Warlock"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["T2Warrior"] = { BabbleClass["Warrior"].." - "..AL["Tier 2 Sets"], "AtlasLootSetItems" };
  --T3 Sets
...
------------------------
    ...
    AtlasLoot_TableNames["HardModeCloaks"] = { AL["Lvl 70 Instance Rewards"].." - "..BabbleInventory["Cloak"], "AtlasLootSetItems" };
    ...
    AtlasLoot_TableNames["HardModeWeapons"] = { AL["Lvl 70 Instance Rewards"].." - "..BabbleInventory["Weapons"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["Legendaries"] = { AL["Legendary Items"], "AtlasLootSetItems" };
    AtlasLoot_TableNames["RareMounts1"] = { AL["Rare Mounts"].." - Original WoW", "AtlasLootSetItems" };
    AtlasLoot_TableNames["RareMounts2"] = { AL["Rare Mounts"].." - The Burning Crusade", "AtlasLootSetItems" };
...
--------------
  ...
  --Seasonal
    ...
    AtlasLoot_TableNames["Winterviel2"] = { "Feast of Winter Veil Presents", "AtlasLootWorldEvents" };
  --Skettis
...
--------------
    ...
    AtlasLoot_TableNames["AlchemyApprentice1"] = { BabbleTrade["Alchemy"]..": "..AL["Apprentice"], "AtlasLootCrafting" };
    AtlasLoot_TableNames["AlchemyJourneyman1"] = { BabbleTrade["Alchemy"]..": "..AL["Journeyman"], "AtlasLootCrafting" };
    AtlasLoot_TableNames["AlchemyExpert1"] = { BabbleTrade["Alchemy"]..": "..AL["Expert"], "AtlasLootCrafting" };
    AtlasLoot_TableNames["AlchemyArtisan1"] = { BabbleTrade["Alchemy"]..": "..AL["Artisan"], "AtlasLootCrafting" };
    AtlasLoot_TableNames["AlchemyArtisan2"] = { BabbleTrade["Alchemy"]..": "..AL["Artisan"], "AtlasLootCrafting" };
    AtlasLoot_TableNames["AlchemyMaster1"] = { BabbleTrade["Alchemy"]..": "..AL["Master"], "AtlasLootCrafting" };
    AtlasLoot_TableNames["AlchemyMaster2"] = { BabbleTrade["Alchemy"]..": "..AL["Master"], "AtlasLootCrafting" };
    AtlasLoot_TableNames["AlchemyMaster3"] = { BabbleTrade["Alchemy"]..": "..AL["Master"], "AtlasLootCrafting" };
...
-----------
  ...
  --Misc Other PvP
    ...
    AtlasLoot_TableNames["PvP70NonSet2"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Cloth"].."/"..BabbleInventory["Leather"], "AtlasLootGeneralPvPItems" };
    AtlasLoot_TableNames["PvP70NonSet3"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Mail"].."/"..BabbleInventory["Plate"], "AtlasLootGeneralPvPItems" };
    ...
    AtlasLoot_TableNames["PVP70Weapons1"] = { AL["PvP Weapons (Level 70)"], "AtlasLootGeneralPvPItems" };
    AtlasLoot_TableNames["PVP70Weapons2"] = { AL["PvP Weapons (Level 70)"], "AtlasLootGeneralPvPItems" };
    AtlasLoot_TableNames["Arena1Weapons1"] = { AL["Arena Season 1 Weapons"], "AtlasLootGeneralPvPItems" };
    AtlasLoot_TableNames["Arena1Weapons2"] = { AL["Arena Season 1 Weapons"], "AtlasLootGeneralPvPItems" };

...
AtlasLoot_DewDropDown = {
    ...
    [4] = {
        [AL["Crafting"]] = {
            [1] = { { BabbleTrade["Alchemy"], "Alchemy", "Submenu" }, },
            [2] = { 
                [AL["Crafted Sets"]] = {
            ...
            [3] = { { AL["Crafted Epic Weapons"], "CraftedWeapons1", "Table" }, },
        },
    },
    [5] = {
        [AL["Sets/Collections"]] = {
...
AtlasLoot_DewDropDown_SubTables = {
    ...
    ["Deadmines"] = {
        { BabbleBoss["Marisa du'Paige"], "VCMarisaduPaige" },
        { BabbleBoss["Brainwashed Noble"], "VCBrainwashedNoble" },
        { BabbleBoss["Foreman Thistlenettle"], "VCForemanThistlenettle" },
    ...
    ["Scholomance"] = {
        ...
        { AL["Set: Necropile Raiment"], "VWOWScholoCloth" },
        { AL["Set: Cadaverous Garb"], "VWOWScholoLeather" },
        { AL["Set: Bloodmail Regalia"], "VWOWScholoMail" },
        { AL["Set: Deathbone Guardian"], "VWOWScholoPlate" },
    },
    ["ShadowfangKeep"] = {
    ...
    ["Pre60Sets"] = {
        { AL["Bloodmail Regalia"], "VWOWScholoMail" },
        { AL["Cadaverous Garb"], "VWOWScholoLeather" },
        { AL["Chain of the Scarlet Crusade"], "VWOWScarletM" },
        { AL["Dal'Rend's Arms"], "VWOWDalRend" },
        { AL["Deathbone Guardian"], "VWOWScholoPlate" },
        { AL["Defias Leather"], "VWOWDeadmines" },
        { AL["Embrace of the Viper"], "VWOWWailingC" },
        { AL["Ironweave Battlesuit"], "VWOWIronweave" },
        { AL["Necropile Raiment"], "VWOWScholoCloth" },
        { AL["Primal Blessing"], "VWOWPrimalBlessing" },
        ...
        { AL["The Twin Blades of Hakkari"], "VWOWHakkariBlades" },
        { AL["Zul'Gurub Rings"], "VWOWZGRings" },
    ...
    ["Lvl70PvPArmor"] = {
        ...
        { BabbleClass["Paladin"], "PVP70RepPaladin1" },

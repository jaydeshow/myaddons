...
-- $Id: sets.cn.lua 78559 2008-07-16 15:36:58Z kurax $
...
Process("BlizzardCollectables1",9,{"=q3=鱼人服装","=q3=乐奇的蛋","=q3=蓝色鱼人卵","=q3=粉色鱼人卵","=q3=熊猫项圈","=q3=破坏神之石","=q3=跳虫绳索","=q3=虚空龙宝宝项圈"}) --Missing: 39656
Process("CardGame1",30,{"","","","","","","","","","","","=q4=地精天气制造机 - 原型机01-B","=q4=X-51虚空火箭特别加强版","=q3=X-51虚空火箭","=q3=修默老爹的宠物饼干","","=q4=风筝龙","=q3=火箭鸡","=q3=纸飞机工具包","","","=q4=迅捷幽灵虎缰绳","=q3=幽灵虎缰绳","=q3=钓鱼椅","=q3=地精杂烩煲","","","=q3=猴子护符","=q3=午餐篮","=q3=球中的小鬼"}) --Missing: 38050, 38233, 38301, 38576, 38577
Process("CardGame2",27,{"","=q4=烈焰徽章","=q4=角鹰兽宝宝","=q4=乌龟坐骑","","","","","","","","","","","","","","=q4=烈焰徽章","=q4=冰霜徽章","","","","","","","=q4=食人魔玩偶","=q4=永久紫色焰火"}) --Missing: 38309, 38310, 38311, 38312, 38313, 38314, 38314
...
Process("Tabards1",23,{"","=q4=烈焰徽章","=q4=冰霜徽章","","","","","","","=q3=夏日天空徽章","=q3=夏日烈焰徽章","","","","","=q2=绿色伊利达雷徽章","=q2=紫色伊利达雷徽章","=q2=血色十字军徽章","=q1=阿古斯之手徽章","=q1=银色黎明徽章","=q1=保卫者的战袍","=q1=冠军徽章","=q1=血骑士战袍"}) --Missing: 38309, 38310, 38311, 38312, 38313, 38314, 38314

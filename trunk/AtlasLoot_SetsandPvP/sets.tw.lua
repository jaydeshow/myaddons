...
Process("BlizzardCollectables1",9,{"=q3=魚人裝束","","=q3=藍色魚人卵","=q3=粉紅魚人蛋","=q3=熊貓項圈","=q3=破壞神之石","=q3=跳蟲繩索","=q3=虛空幼龍項圈"}) --Missing: 30360
Process("CardGame1",30,{"","=q4=烈焰外袍","=q4=角鷹獸寶寶","=q4=烏龜坐騎","","","=q3=巴那納斯符咒","=q3=午餐籃","=q3=球中的小鬼","","","=q4=迅捷鬼靈之虎韁繩","=q3=鬼靈之虎韁繩","=q3=釣魚椅","=q3=哥布林燴肉罐","","=q4=飛龍風箏","=q3=火箭雞","=q3=紙飛行器工具組","","","=q4=X51型虛空火箭極限版","=q3=X51型虛空火箭","=q4=哥布林天氣機 - 原型機 01-B","=q3=休莫爾老爹的老派寵物軟餅"}) --Missing: 38050, 38233, 38301
Process("CardGame2",26,{"","","","","","","","","","","","","","","","","","=q4=冰霜外袍","","","","","","","=q4=巨魔塑像","=q4=無止境的紫色煙火"}) --Missing: 38309, 38310, 38311, 38312, 38313, 38314, 38314, 38577
...
Process("RareMounts1",26,{"=q4=迅捷虛空龍","=q4=殘忍虛空龍","","=q4=歐爾灰燼","=q4=熾炎戰馬韁繩","=q4=烏鴉領主韁繩","=q4=阿曼尼戰熊","","=q4=迅捷鬼靈之虎韁繩","=q3=鬼靈之虎韁繩","=q4=X51型虛空火箭極限版","=q3=X51型虛空火箭","","","","=q4=渦輪增壓飛行器控制裝置","=q3=飛行器控制裝置","","=q4=迅捷啤酒節山羊","=q3=啤酒節山羊","","=q4=迅捷飛行掃帚","=q4=迅捷魔法掃帚","=q3=飛行掃帚","=q3=老舊的魔法掃帚","=q2=不牢固的魔法掃帚"})
...
Process("Tabards1",31,{"=q4=烈焰外袍","=q4=冰霜外袍","=q3=夏日晴空外袍","=q3=夏日烈焰外袍","","","=q1=奧多爾外袍","=q1=塞納里奧遠征外袍","=q1=榮譽堡外袍","=q1=時光守望者外袍","=q1=陰鬱城外袍","=q1=歐格利拉外袍","=q1=薩塔外袍","=q1=斯博格爾外袍","=q1=阿格斯之手外袍","=q1=破碎之日外袍","=q2=綠色伊利達瑞戰利外袍","=q2=伊利達瑞紫色勝利外袍","=q2=血色十字軍外袍","=q1=冠軍外袍","","","=q1=血騎士外袍","=q1=聯合團外袍","=q1=卡爾奈外袍","=q1=瑪格哈外袍","=q1=占卜者外袍","=q1=禦天者外袍","=q1=銀色黎明外袍","=q1=保衛者外袍","=q1=索爾瑪外袍"})

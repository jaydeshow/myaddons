...
-- $Id: sets.tw.lua 78559 2008-07-16 15:36:58Z kurax $
...
Process("BlizzardCollectables1",9,{"=q3=魚人裝束","","=q3=藍色魚人卵","=q3=粉紅魚人蛋","=q3=熊貓項圈","=q3=破壞神之石","=q3=跳蟲繩索","=q3=虛空幼龍項圈"}) --Missing: 30360, 39656
Process("CardGame1",30,{"","","","","","","","","","","","=q4=哥布林天氣機 - 原型機 01-B","=q4=X51型虛空火箭極限版","=q3=X51型虛空火箭","=q3=休莫爾老爹的老派寵物軟餅","","=q4=飛龍風箏","=q3=火箭雞","=q3=紙飛行器工具組","","","=q4=迅捷鬼靈之虎韁繩","=q3=鬼靈之虎韁繩","=q3=釣魚椅","=q3=哥布林燴肉罐","","","=q3=巴那納斯符咒","=q3=午餐籃","=q3=球中的小鬼"}) --Missing: 38050, 38233, 38301, 38576, 38577
Process("CardGame2",27,{"","=q4=烈焰外袍","=q4=角鷹獸寶寶","=q4=烏龜坐騎","","","","","","","","","","","","","","=q4=烈焰外袍","=q4=冰霜外袍","","","","","","","=q4=巨魔塑像","=q4=無止境的紫色煙火"}) --Missing: 38309, 38310, 38311, 38312, 38313, 38314, 38314
...
Process("Tabards1",23,{"","=q4=烈焰外袍","=q4=冰霜外袍","","","","","","","=q3=夏日晴空外袍","=q3=夏日烈焰外袍","","","","","=q2=綠色伊利達瑞戰利外袍","=q2=伊利達瑞紫色勝利外袍","=q2=血色十字軍外袍","=q1=阿格斯之手外袍","=q1=銀色黎明外袍","=q1=保衛者外袍","=q1=冠軍外袍","=q1=血騎士外袍"}) --Missing: 38309, 38310, 38311, 38312, 38313, 38314, 38314

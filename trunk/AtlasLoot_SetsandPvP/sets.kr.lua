...
Process("BlizzardCollectables1",9,{"=q3=멀록 복장","","=q3=멀록 알","=q3=분홍색 멀록 알","=q3=판다 목걸이","=q3=디아블로 소환석","=q3=저글링 목줄","=q3=황천의 새끼용 목줄"}) --Missing: 30360
...
Process("CardGame2",26,{"","","","","","","","","","","","","","","","","","=q4=냉기의 휘장","","","","","","","=q4=오우거 우상 조각","=q4=영원한 보라색 폭죽"}) --Missing: 38309, 38310, 38311, 38312, 38313, 38314, 38314, 38577
...
Process("RareMounts1",26,{"=q4=날쌘 황천의 비룡","=q4=무자비한 황천의 비룡","","=q4=알라르의 재","=q4=불타는 전투마 고삐","=q4=까마귀 군주의 고삐","=q4=아마니 전투곰","","=q4=날쌘 유령 호랑이 고삐","=q3=유령 호랑이 고삐","=q4=X-51 초강력 황천로켓","=q3=X-51 황천로켓","","","","=q4=터보 충전 비행기 조종기","=q3=비행기 조종기","","=q4=날쌘 가을 축제 산양","=q3=가을 축제 산양","","=q4=날쌘 비행 빗자루","=q4=날쌘 마법의 빗자루","=q3=비행 빗자루","=q3=오래된 마법의 빗자루","=q2=낡은 마법의 빗자루"})

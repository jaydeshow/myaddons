...
elseif GetLocale() == "zhCN" then
	...
	ABOUT = "关于"
	PRINT_ADDON_INFO = "显示插件信息"
	DONATE = "捐赠"
	DONATE_DESC = "给插件作者一些捐赠。"
	HOWTO_DONATE_WINDOWS = "按Ctrl-A选择连接，然后按Ctrl-C复制，再按Alt-Tab切出游戏，打开你的IE/FF浏览器并把连接复制到浏览器地址栏中进行访问。"
	HOWTO_DONATE_MAC = "按Cmd-A选择连接，然后按Cmd-C复制，再按Cmd-Tab切出游戏，打开网站浏览器，并把连接地址复制到浏览器地址栏中进行访问。"

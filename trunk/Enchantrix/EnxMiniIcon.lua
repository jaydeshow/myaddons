--[[
	...
	Revision: $Id: EnxMiniIcon.lua 2423 2007-11-10 07:37:23Z Norganna $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Enchantrix/EnxMiniIcon.lua $", "$Rev: 2423 $")

...
Revision: $Revision: 68895 $
Author: Whitetooth
Email: hotdogee [at] gmail [dot] com
LastUpdate: $Date: 2008-04-10 05:30:35 -0400 (Thu, 10 Apr 2008) $
Website:
Documentation:
...
local MINOR_VERSION = tonumber(("$Revision: 68895 $"):sub(12, -3))
...
PatternLocale.zhCN = {
	...
	["StatIDLookup"] = {
		...
		["在猎豹、熊、巨熊和枭兽形态下的攻击强度提高"] = {"FERAL_AP",}, 
		["在猎豹、熊、巨熊和枭兽形态下的攻击强度"] = {"FERAL_AP",}, 
		["使你的近战和远程攻击强度"] = {"AP"},
		...
		["使法术和魔法效果的治疗和伤害提高最多"] = {"SPELL_DMG", "HEAL"},

--[[
	...
	Revision: $Id: EnxTooltip.lua 2831 2008-02-02 20:32:14Z ccox $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Enchantrix/EnxTooltip.lua $", "$Rev: 2831 $")

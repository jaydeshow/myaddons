--[[
	...
	Revision: $Id: EnxLocale.lua 2225 2007-09-24 12:09:54Z norganna $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Enchantrix/EnxLocale.lua $", "$Rev: 2225 $")
